...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-angular2/node_modules/angular2/src/i18n/expander.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-angular2/node_modules/angular2/src/i18n/expander.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-angular2/node_modules/angular2/src/i18n/</a> &#187; expander.js</div>
</div>
<div class="body">
 ...
 * ```
 */
<span class="fstat-no" title="function not covered" >function expandNodes(nodes) {</span>
<span class="cstat-no" title="statement not covered" >    var e = new _Expander();</span>
<span class="cstat-no" title="statement not covered" >    var n = html_ast_1.htmlVisitAll(e, nodes);</span>
<span class="cstat-no" title="statement not covered" >    return new ExpansionResult(n, e.expanded);</span>
}
exports.expandNodes = expandNodes;
var ExpansionResult = (function () {
<span class="fstat-no" title="function not covered" >    function ExpansionResult(nodes, expanded) {</span>
...
<span class="fstat-no" title="function not covered" >    function _Expander() {</span>
<span class="cstat-no" title="statement not covered" >        this.expanded = false;</span>
    }
    _Expander.prototype.visitElement = <span class="fstat-no" title="function not covered" >function (ast, context) {</span>
<span class="cstat-no" title="statement not covered" >        return new html_ast_1.HtmlElementAst(ast.name, ast.attrs, html_ast_1.htmlVisitAll(this, ast.children), ast.sourceSpan, ast.startSourceSpan, ast.endSourceSpan);</span>
    };
    _Expander.prototype.visitAttr = <span class="fstat-no" title="function not covered" >function (ast, context) {</span> <span class="cstat-no" title="statement not covered" >return ast; </span>};
    _Expander.prototype.visitText = <span class="fstat-no" title="function not covered" >function (ast, context) {</span> <span class="cstat-no" title="statement not covered" >return ast; </span>};
    _Expander.prototype.visitComment = <span class="fstat-no" title="function not covered" >function (ast, context) {</span> <span class="cstat-no" title="statement not covered" >return ast; </span>};
    _Expander.prototype.visitExpansion = <span class="fstat-no" title="function not covered" >function (ast, context) {</span>
<span class="cstat-no" title="statement not covered" >        this.expanded = true;</span>
<span class="cstat-no" title="statement not covered" >        return ast.type == "plural" ? _expandPluralForm(ast) : _expandDefaultForm(ast);</span>
    };
    _Expander.prototype.visitExpansionCase = <span class="fstat-no" title="function not covered" >function (ast, context) {</span>
<span class="cstat-no" title="statement not covered" >        throw new exceptions_1.BaseException("Should not be reached");</span>
    };
    return _Expander;
}());
<span class="fstat-no" title="function not covered" >function _expandPluralForm(ast) {</span>
<span class="cstat-no" title="statement not covered" >    var children = ast.cases.map(<span class="fstat-no" title="function not covered" >function (c) {</span></span>
<span class="cstat-no" title="statement not covered" >        var expansionResult = expandNodes(c.expression);</span>
<span class="cstat-no" title="statement not covered" >        var i18nAttrs = expansionResult.expanded ?</span>
            [] :
            [new html_ast_1.HtmlAttrAst("i18n", ast.type + "_" + c.value, c.valueSourceSpan)];
<span class="cstat-no" title="statement not covered" >        return new html_ast_1.HtmlElementAst("template", [</span>
...
<span class="cstat-no" title="statement not covered" >    var switchAttr = new html_ast_1.HtmlAttrAst("[ngPlural]", ast.switchValue, ast.switchValueSourceSpan);</span>
<span class="cstat-no" title="statement not covered" >    return new html_ast_1.HtmlElementAst("ul", [switchAttr], children, ast.sourceSpan, ast.sourceSpan, ast.sourceSpan);</span>
}
<span class="fstat-no" title="function not covered" >function _expandDefaultForm(ast) {</span>
<span class="cstat-no" title="statement not covered" >    var children = ast.cases.map(<span class="fstat-no" title="function not covered" >function (c) {</span></span>
<span class="cstat-no" title="statement not covered" >        var expansionResult = expandNodes(c.expression);</span>
<span class="cstat-no" title="statement not covered" >        var i18nAttrs = expansionResult.expanded ?</span>
            [] :
...
<span class="cstat-no" title="statement not covered" >    var switchAttr = new html_ast_1.HtmlAttrAst("[ngSwitch]", ast.switchValue, ast.switchValueSourceSpan);</span>
<span class="cstat-no" title="statement not covered" >    return new html_ast_1.HtmlElementAst("ul", [switchAttr], children, ast.sourceSpan, ast.sourceSpan, ast.sourceSpan);</span>
}
