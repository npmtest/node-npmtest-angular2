...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-angular2/node_modules/angular2/src/http/base_request_options.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-angular2/node_modules/angular2/src/http/base_request_options.js</span></h1>
    <h2>
        
        Statements: <span class="metric">25% <small>(11 / 44)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">12.5% <small>(9 / 72)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-angular2/node_modules/angular2/src/http/</a> &#187; base_request_options.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >var url_search_params_1 = require('./url_search_params');</span>
<span class="cstat-no" title="statement not covered" >var http_utils_1 = require('./http_utils');</span>
/**
...
<span class="cstat-no" title="statement not covered" >        var _b = _a === void 0 ? {} : _a, method = _b.method, headers = _b.headers, body = _b.body, url = _b.url, search = _b.search;</span>
...
<span class="cstat-no" title="statement not covered" >        this.search = lang_1.isPresent(search) ? (lang_1.isString(search) ? new url_search_params_1.URLSearchParams((search)) :</span>
            (search)) :
            null;
    }
    /**
...
<span class="cstat-no" title="statement not covered" >        _super.call(this, { method: enums_1.RequestMethod.Get, headers: new headers_1.Headers() });</span>
    }
<span class="cstat-no" title="statement not covered" >    BaseRequestOptions = __decorate([</span>
        core_1.Injectable(), 
