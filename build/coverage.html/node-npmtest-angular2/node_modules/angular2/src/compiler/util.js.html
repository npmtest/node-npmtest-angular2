...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-angular2/node_modules/angular2/src/compiler/util.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-angular2/node_modules/angular2/src/compiler/util.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-angular2/node_modules/angular2/src/compiler/</a> &#187; util.js</div>
</div>
<div class="body">
...
exports.MODULE_SUFFIX = lang_1.IS_DART ? <span class="branch-0 cbranch-no" title="branch not covered" >'.dart' </span>: '';
var CAMEL_CASE_REGEXP = /([A-Z])/g;
var DASH_CASE_REGEXP = /-([a-z])/g;
<span class="fstat-no" title="function not covered" >function camelCaseToDashCase(input) {</span>
<span class="cstat-no" title="statement not covered" >    return lang_1.StringWrapper.replaceAllMapped(input, CAMEL_CASE_REGEXP, <span class="fstat-no" title="function not covered" >function (m) {</span> <span class="cstat-no" title="statement not covered" >return '-' + m[1].toLowerCase(); </span>});</span>
}
exports.camelCaseToDashCase = camelCaseToDashCase;
<span class="fstat-no" title="function not covered" >function dashCaseToCamelCase(input) {</span>
<span class="cstat-no" title="statement not covered" >    return lang_1.StringWrapper.replaceAllMapped(input, DASH_CASE_REGEXP, <span class="fstat-no" title="function not covered" >function (m) {</span> <span class="cstat-no" title="statement not covered" >return m[1].toUpperCase(); </span>});</span>
}
exports.dashCaseToCamelCase = dashCaseToCamelCase;
<span class="fstat-no" title="function not covered" >function splitAtColon(input, defaultValues) {</span>
<span class="cstat-no" title="statement not covered" >    var parts = lang_1.StringWrapper.split(input.trim(), /\s*:\s*/g);</span>
...
<span class="cstat-no" title="statement not covered" >        return defaultValues;</span>
    }
}
exports.splitAtColon = splitAtColon;
<span class="fstat-no" title="function not covered" >function sanitizeIdentifier(name) {</span>
<span class="cstat-no" title="statement not covered" >    return lang_1.StringWrapper.replaceAll(name, /\W/g, '_');</span>
}
