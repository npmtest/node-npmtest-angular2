...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-angular2/node_modules/angular2/src/compiler/url_resolver.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-angular2/node_modules/angular2/src/compiler/url_resolver.js</span></h1>
    <h2>
        
        Statements: <span class="metric">10.85% <small>(14 / 129)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">10% <small>(9 / 90)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-angular2/node_modules/angular2/src/compiler/</a> &#187; url_resolver.js</div>
</div>
<div class="body">
...
339
340
341</td><td class="line-coverage"><span class="cline-any cline-yes">2</span>
...
<span class="cstat-no" title="statement not covered" >var application_tokens_1 = require('angular2/src/core/application_tokens');</span>
<span class="cstat-no" title="statement not covered" >var _ASSET_SCHEME = 'asset:';</span>
/**
 * Create a {@link UrlResolver} with no package prefix.
 */
<span class="fstat-no" title="function not covered" >function createUrlResolverWithoutPackagePrefix() {</span>
<span class="cstat-no" title="statement not covered" >    return new UrlResolver();</span>
}
<span class="cstat-no" title="statement not covered" >exports.createUrlResolverWithoutPackagePrefix = createUrlResolverWithoutPackagePrefix;</span>
<span class="fstat-no" title="function not covered" >function createOfflineCompileUrlResolver() {</span>
<span class="cstat-no" title="statement not covered" >    return new UrlResolver(_ASSET_SCHEME);</span>
}
<span class="cstat-no" title="statement not covered" >exports.createOfflineCompileUrlResolver = createOfflineCompileUrlResolver;</span>
/**
 * A default provider for {@link PACKAGE_ROOT_URL} that maps to '/'.
 */
<span class="cstat-no" title="statement not covered" >exports.DEFAULT_PACKAGE_URL_PROVIDER = new di_1.Provider(application_tokens_1.PACKAGE_ROOT_URL, { useValue: "/" });</span>
/**
 ...
 */
<span class="cstat-no" title="statement not covered" >var UrlResolver = (<span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="fstat-no" title="function not covered" >    function UrlResolver(_packagePrefix) {</span>
<span class="cstat-no" title="statement not covered" >        if (_packagePrefix === void 0) { <span class="cstat-no" title="statement not covered" >_packagePrefix = null; </span>}</span>
<span class="cstat-no" title="statement not covered" >        this._packagePrefix = _packagePrefix;</span>
    }
    /**
     ...
     */
<span class="cstat-no" title="statement not covered" >    UrlResolver.prototype.resolve = <span class="fstat-no" title="function not covered" >function (baseUrl, url) {</span></span>
<span class="cstat-no" title="statement not covered" >        var resolvedUrl = url;</span>
<span class="cstat-no" title="statement not covered" >        if (lang_1.isPresent(baseUrl) &amp;&amp; baseUrl.length &gt; 0) {</span>
<span class="cstat-no" title="statement not covered" >            resolvedUrl = _resolveUrl(baseUrl, resolvedUrl);</span>
        }
<span class="cstat-no" title="statement not covered" >        var resolvedParts = _split(resolvedUrl);</span>
<span class="cstat-no" title="statement not covered" >        var prefix = this._packagePrefix;</span>
<span class="cstat-no" title="statement not covered" >        if (lang_1.isPresent(prefix) &amp;&amp; lang_1.isPresent(resolvedParts) &amp;&amp;</span>
            resolvedParts[_ComponentIndex.Scheme] == "package") {
<span class="cstat-no" title="statement not covered" >            var path = resolvedParts[_ComponentIndex.Path];</span>
<span class="cstat-no" title="statement not covered" >            if (this._packagePrefix === _ASSET_SCHEME) {</span>
<span class="cstat-no" title="statement not covered" >                var pathSegements = path.split(/\//);</span>
<span class="cstat-no" title="statement not covered" >                resolvedUrl = "asset:" + pathSegements[0] + "/lib/" + pathSegements.slice(1).join('/');</span>
            }
            else {
<span class="cstat-no" title="statement not covered" >                prefix = lang_1.StringWrapper.stripRight(prefix, '/');</span>
<span class="cstat-no" title="statement not covered" >                path = lang_1.StringWrapper.stripLeft(path, '/');</span>
<span class="cstat-no" title="statement not covered" >                return prefix + "/" + path;</span>
            }
        }
<span class="cstat-no" title="statement not covered" >        return resolvedUrl;</span>
    };
<span class="cstat-no" title="statement not covered" >    UrlResolver = __decorate([</span>
        di_1.Injectable(),
 ...
 */
<span class="fstat-no" title="function not covered" >function getUrlScheme(url) {</span>
<span class="cstat-no" title="statement not covered" >    var match = _split(url);</span>
<span class="cstat-no" title="statement not covered" >    return (match &amp;&amp; match[_ComponentIndex.Scheme]) || "";</span>
}
<span class="cstat-no" title="statement not covered" >exports.getUrlScheme = getUrlScheme;</span>
 ...
 */
<span class="fstat-no" title="function not covered" >function _buildFromEncodedParts(opt_scheme, opt_userInfo, opt_domain, opt_port, opt_path, opt_queryData, opt_fragment) {</span>
<span class="cstat-no" title="statement not covered" >    var out = [];</span>
<span class="cstat-no" title="statement not covered" >    if (lang_1.isPresent(opt_scheme)) {</span>
<span class="cstat-no" title="statement not covered" >        out.push(opt_scheme + ':');</span>
    }
<span class="cstat-no" title="statement not covered" >    if (lang_1.isPresent(opt_domain)) {</span>
<span class="cstat-no" title="statement not covered" >        out.push('//');</span>
<span class="cstat-no" title="statement not covered" >        if (lang_1.isPresent(opt_userInfo)) {</span>
<span class="cstat-no" title="statement not covered" >            out.push(opt_userInfo + '@');</span>
        }
<span class="cstat-no" title="statement not covered" >        out.push(opt_domain);</span>
<span class="cstat-no" title="statement not covered" >        if (lang_1.isPresent(opt_port)) {</span>
<span class="cstat-no" title="statement not covered" >            out.push(':' + opt_port);</span>
        }
    }
<span class="cstat-no" title="statement not covered" >    if (lang_1.isPresent(opt_path)) {</span>
<span class="cstat-no" title="statement not covered" >        out.push(opt_path);</span>
    }
<span class="cstat-no" title="statement not covered" >    if (lang_1.isPresent(opt_queryData)) {</span>
<span class="cstat-no" title="statement not covered" >        out.push('?' + opt_queryData);</span>
    }
<span class="cstat-no" title="statement not covered" >    if (lang_1.isPresent(opt_fragment)) {</span>
<span class="cstat-no" title="statement not covered" >        out.push('#' + opt_fragment);</span>
    }
 ...
 * @internal
 */
<span class="cstat-no" title="statement not covered" >var _splitRe = lang_1.RegExpWrapper.create('^' +</span>
    '(?:' +
    '([^:/?#.]+)' +
 ...
 * @enum {number}
 */
<span class="cstat-no" title="statement not covered" >var _ComponentIndex;</span>
<span class="cstat-no" title="statement not covered" >(<span class="fstat-no" title="function not covered" >function (_ComponentIndex) {</span></span>
<span class="cstat-no" title="statement not covered" >    _ComponentIndex[_ComponentIndex["Scheme"] = 1] = "Scheme";</span>
<span class="cstat-no" title="statement not covered" >    _ComponentIndex[_ComponentIndex["UserInfo"] = 2] = "UserInfo";</span>
<span class="cstat-no" title="statement not covered" >    _ComponentIndex[_ComponentIndex["Domain"] = 3] = "Domain";</span>
<span class="cstat-no" title="statement not covered" >    _ComponentIndex[_ComponentIndex["Port"] = 4] = "Port";</span>
<span class="cstat-no" title="statement not covered" >    _ComponentIndex[_ComponentIndex["Path"] = 5] = "Path";</span>
<span class="cstat-no" title="statement not covered" >    _ComponentIndex[_ComponentIndex["QueryData"] = 6] = "QueryData";</span>
<span class="cstat-no" title="statement not covered" >    _ComponentIndex[_ComponentIndex["Fragment"] = 7] = "Fragment";</span>
 ...
 */
<span class="fstat-no" title="function not covered" >function _split(uri) {</span>
<span class="cstat-no" title="statement not covered" >    return lang_1.RegExpWrapper.firstMatch(_splitRe, uri);</span>
}
/**
  ...
  */
<span class="fstat-no" title="function not covered" >function _removeDotSegments(path) {</span>
<span class="cstat-no" title="statement not covered" >    if (path == '/')</span>
<span class="cstat-no" title="statement not covered" >        return '/';</span>
<span class="cstat-no" title="statement not covered" >    var leadingSlash = path[0] == '/' ? '/' : '';</span>
<span class="cstat-no" title="statement not covered" >    var trailingSlash = path[path.length - 1] === '/' ? '/' : '';</span>
...
<span class="cstat-no" title="statement not covered" >    for (var pos = 0; pos &lt; segments.length; pos++) {</span>
...
<span class="cstat-no" title="statement not covered" >                break;</span>
            default:
<span class="cstat-no" title="statement not covered" >                out.push(segment);</span>
        }
    }
<span class="cstat-no" title="statement not covered" >    if (leadingSlash == '') {</span>
<span class="cstat-no" title="statement not covered" >        while (up-- &gt; 0) {</span>
<span class="cstat-no" title="statement not covered" >            out.unshift('..');</span>
        }
<span class="cstat-no" title="statement not covered" >        if (out.length === 0)</span>
<span class="cstat-no" title="statement not covered" >            out.push('.');</span>
    }
<span class="cstat-no" title="statement not covered" >    return leadingSlash + out.join('/') + trailingSlash;</span>
}
/**
 ...
 * @return {string}
 */
<span class="fstat-no" title="function not covered" >function _joinAndCanonicalizePath(parts) {</span>
<span class="cstat-no" title="statement not covered" >    var path = parts[_ComponentIndex.Path];</span>
<span class="cstat-no" title="statement not covered" >    path = lang_1.isBlank(path) ? '' : _removeDotSegments(path);</span>
<span class="cstat-no" title="statement not covered" >    parts[_ComponentIndex.Path] = path;</span>
<span class="cstat-no" title="statement not covered" >    return _buildFromEncodedParts(parts[_ComponentIndex.Scheme], parts[_ComponentIndex.UserInfo], parts[_ComponentIndex.Domain], parts[_ComponentIndex.Port], path, parts[_ComponentIndex.QueryData], parts[_ComponentIndex.Fragment]);</span>
}
/**
 * Resolves a URL.
 ...
 * @return {string}
 */
<span class="fstat-no" title="function not covered" >function _resolveUrl(base, url) {</span>
<span class="cstat-no" title="statement not covered" >    var parts = _split(encodeURI(url));</span>
<span class="cstat-no" title="statement not covered" >    var baseParts = _split(base);</span>
<span class="cstat-no" title="statement not covered" >    if (lang_1.isPresent(parts[_ComponentIndex.Scheme])) {</span>
<span class="cstat-no" title="statement not covered" >        return _joinAndCanonicalizePath(parts);</span>
    }
    else {
<span class="cstat-no" title="statement not covered" >        parts[_ComponentIndex.Scheme] = baseParts[_ComponentIndex.Scheme];</span>
    }
<span class="cstat-no" title="statement not covered" >    for (var i = _ComponentIndex.Scheme; i &lt;= _ComponentIndex.Port; i++) {</span>
<span class="cstat-no" title="statement not covered" >        if (lang_1.isBlank(parts[i])) {</span>
<span class="cstat-no" title="statement not covered" >            parts[i] = baseParts[i];</span>
        }
    }
<span class="cstat-no" title="statement not covered" >    if (parts[_ComponentIndex.Path][0] == '/') {</span>
<span class="cstat-no" title="statement not covered" >        return _joinAndCanonicalizePath(parts);</span>
    }
<span class="cstat-no" title="statement not covered" >    var path = baseParts[_ComponentIndex.Path];</span>
...
<span class="cstat-no" title="statement not covered" >    path = path.substring(0, index + 1) + parts[_ComponentIndex.Path];</span>
<span class="cstat-no" title="statement not covered" >    parts[_ComponentIndex.Path] = path;</span>
<span class="cstat-no" title="statement not covered" >    return _joinAndCanonicalizePath(parts);</span>
}
