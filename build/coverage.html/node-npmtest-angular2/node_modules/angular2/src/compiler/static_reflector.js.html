...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-angular2/node_modules/angular2/src/compiler/static_reflector.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-angular2/node_modules/angular2/src/compiler/static_reflector.js</span></h1>
    <h2>
        ...
        Lines: <span class="metric">4.17% <small>(10 / 240)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-angular2/node_modules/angular2/src/compiler/</a> &#187; static_reflector.js</div>
</div>
<div class="body">
...
411
412
413</td><td class="line-coverage"><span class="cline-any cline-yes">2</span>
 ...
 */
<span class="cstat-no" title="statement not covered" >var StaticType = (<span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="fstat-no" title="function not covered" >    function StaticType(moduleId, name) {</span>
<span class="cstat-no" title="statement not covered" >        this.moduleId = moduleId;</span>
<span class="cstat-no" title="statement not covered" >        this.name = name;</span>
    }
<span class="cstat-no" title="statement not covered" >    return StaticType;</span>
}());
<span class="cstat-no" title="statement not covered" >exports.StaticType = StaticType;</span>
/**
 * A static reflector implements enough of the Reflector API that is necessary to compile
 * templates statically.
 */
<span class="cstat-no" title="statement not covered" >var StaticReflector = (<span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="fstat-no" title="function not covered" >    function StaticReflector(host) {</span>
<span class="cstat-no" title="statement not covered" >        this.host = host;</span>
<span class="cstat-no" title="statement not covered" >        this.typeCache = new Map();</span>
<span class="cstat-no" title="statement not covered" >        this.annotationCache = new Map();</span>
<span class="cstat-no" title="statement not covered" >        this.propertyCache = new Map();</span>
<span class="cstat-no" title="statement not covered" >        this.parameterCache = new Map();</span>
<span class="cstat-no" title="statement not covered" >        this.metadataCache = new Map();</span>
<span class="cstat-no" title="statement not covered" >        this.conversionMap = new Map();</span>
<span class="cstat-no" title="statement not covered" >        this.initializeConversionMap();</span>
    }
<span class="cstat-no" title="statement not covered" >    StaticReflector.prototype.importUri = <span class="fstat-no" title="function not covered" >function (typeOrFunc) {</span> <span class="cstat-no" title="statement not covered" >return typeOrFunc.moduleId; </span>};</span>
    /**
     ...
     */
<span class="cstat-no" title="statement not covered" >    StaticReflector.prototype.getStaticType = <span class="fstat-no" title="function not covered" >function (moduleId, name) {</span></span>
<span class="cstat-no" title="statement not covered" >        var key = "\"" + moduleId + "\"." + name;</span>
<span class="cstat-no" title="statement not covered" >        var result = this.typeCache.get(key);</span>
<span class="cstat-no" title="statement not covered" >        if (!lang_1.isPresent(result)) {</span>
<span class="cstat-no" title="statement not covered" >            result = new StaticType(moduleId, name);</span>
<span class="cstat-no" title="statement not covered" >            this.typeCache.set(key, result);</span>
        }
<span class="cstat-no" title="statement not covered" >        return result;</span>
    };
<span class="cstat-no" title="statement not covered" >    StaticReflector.prototype.annotations = <span class="fstat-no" title="function not covered" >function (type) {</span></span>
<span class="cstat-no" title="statement not covered" >        var _this = this;</span>
<span class="cstat-no" title="statement not covered" >        var annotations = this.annotationCache.get(type);</span>
<span class="cstat-no" title="statement not covered" >        if (!lang_1.isPresent(annotations)) {</span>
<span class="cstat-no" title="statement not covered" >            var classMetadata = this.getTypeMetadata(type);</span>
<span class="cstat-no" title="statement not covered" >            if (lang_1.isPresent(classMetadata['decorators'])) {</span>
<span class="cstat-no" title="statement not covered" >                annotations = classMetadata['decorators']</span>
                    .map(<span class="fstat-no" title="function not covered" >function (decorator) {</span> <span class="cstat-no" title="statement not covered" >return _this.convertKnownDecorator(type.moduleId, decorator); </span>})
                    .filter(<span class="fstat-no" title="function not covered" >function (decorator) {</span> <span class="cstat-no" title="statement not covered" >return lang_1.isPresent(decorator); </span>});
            }
            else {
<span class="cstat-no" title="statement not covered" >                annotations = [];</span>
            }
<span class="cstat-no" title="statement not covered" >            this.annotationCache.set(type, annotations);</span>
        }
<span class="cstat-no" title="statement not covered" >        return annotations;</span>
    };
<span class="cstat-no" title="statement not covered" >    StaticReflector.prototype.propMetadata = <span class="fstat-no" title="function not covered" >function (type) {</span></span>
<span class="cstat-no" title="statement not covered" >        var propMetadata = this.propertyCache.get(type);</span>
<span class="cstat-no" title="statement not covered" >        if (!lang_1.isPresent(propMetadata)) {</span>
<span class="cstat-no" title="statement not covered" >            var classMetadata = this.getTypeMetadata(type);</span>
<span class="cstat-no" title="statement not covered" >            propMetadata = this.getPropertyMetadata(type.moduleId, classMetadata['members']);</span>
<span class="cstat-no" title="statement not covered" >            if (!lang_1.isPresent(propMetadata)) {</span>
<span class="cstat-no" title="statement not covered" >                propMetadata = {};</span>
            }
<span class="cstat-no" title="statement not covered" >            this.propertyCache.set(type, propMetadata);</span>
        }
<span class="cstat-no" title="statement not covered" >        return propMetadata;</span>
    };
<span class="cstat-no" title="statement not covered" >    StaticReflector.prototype.parameters = <span class="fstat-no" title="function not covered" >function (type) {</span></span>
<span class="cstat-no" title="statement not covered" >        var parameters = this.parameterCache.get(type);</span>
<span class="cstat-no" title="statement not covered" >        if (!lang_1.isPresent(parameters)) {</span>
<span class="cstat-no" title="statement not covered" >            var classMetadata = this.getTypeMetadata(type);</span>
<span class="cstat-no" title="statement not covered" >            if (lang_1.isPresent(classMetadata)) {</span>
<span class="cstat-no" title="statement not covered" >                var members = classMetadata['members'];</span>
<span class="cstat-no" title="statement not covered" >                if (lang_1.isPresent(members)) {</span>
<span class="cstat-no" title="statement not covered" >                    var ctorData = members['__ctor__'];</span>
<span class="cstat-no" title="statement not covered" >                    if (lang_1.isPresent(ctorData)) {</span>
<span class="cstat-no" title="statement not covered" >                        var ctor = ctorData.find(<span class="fstat-no" title="function not covered" >function (a) {</span> <span class="cstat-no" title="statement not covered" >return a['__symbolic'] === 'constructor'; </span>});</span>
<span class="cstat-no" title="statement not covered" >                        parameters = this.simplify(type.moduleId, ctor['parameters']);</span>
                    }
                }
            }
<span class="cstat-no" title="statement not covered" >            if (!lang_1.isPresent(parameters)) {</span>
...
<span class="cstat-no" title="statement not covered" >            this.parameterCache.set(type, parameters);</span>
        }
<span class="cstat-no" title="statement not covered" >        return parameters;</span>
    };
<span class="cstat-no" title="statement not covered" >    StaticReflector.prototype.initializeConversionMap = <span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >        var _this = this;</span>
<span class="cstat-no" title="statement not covered" >        var core_metadata = this.host.resolveModule('angular2/src/core/metadata');</span>
<span class="cstat-no" title="statement not covered" >        var conversionMap = this.conversionMap;</span>
<span class="cstat-no" title="statement not covered" >        conversionMap.set(this.getStaticType(core_metadata, 'Directive'), <span class="fstat-no" title="function not covered" >function (moduleContext, expression) {</span></span>
<span class="cstat-no" title="statement not covered" >            var p0 = _this.getDecoratorParameter(moduleContext, expression, 0);</span>
<span class="cstat-no" title="statement not covered" >            if (!lang_1.isPresent(p0)) {</span>
<span class="cstat-no" title="statement not covered" >                p0 = {};</span>
            }
...
<span class="cstat-no" title="statement not covered" >        conversionMap.set(this.getStaticType(core_metadata, 'Component'), <span class="fstat-no" title="function not covered" >function (moduleContext, expression) {</span></span>
<span class="cstat-no" title="statement not covered" >            var p0 = _this.getDecoratorParameter(moduleContext, expression, 0);</span>
<span class="cstat-no" title="statement not covered" >            if (!lang_1.isPresent(p0)) {</span>
<span class="cstat-no" title="statement not covered" >                p0 = {};</span>
            }
...
<span class="cstat-no" title="statement not covered" >        conversionMap.set(this.getStaticType(core_metadata, 'Input'), <span class="fstat-no" title="function not covered" >function (moduleContext, expression) {</span> <span class="cstat-no" title="statement not covered" >return new metadata_1.InputMetadata(_this.getDecoratorParameter(moduleContext, expression, 0)); </span>});</span>
<span class="cstat-no" title="statement not covered" >        conversionMap.set(this.getStaticType(core_metadata, 'Output'), <span class="fstat-no" title="function not covered" >function (moduleContext, expression) {</span> <span class="cstat-no" title="statement not covered" >return new metadata_1.OutputMetadata(_this.getDecoratorParameter(moduleContext, expression, 0)); </span>});</span>
<span class="cstat-no" title="statement not covered" >        conversionMap.set(this.getStaticType(core_metadata, 'View'), <span class="fstat-no" title="function not covered" >function (moduleContext, expression) {</span></span>
<span class="cstat-no" title="statement not covered" >            var p0 = _this.getDecoratorParameter(moduleContext, expression, 0);</span>
<span class="cstat-no" title="statement not covered" >            if (!lang_1.isPresent(p0)) {</span>
<span class="cstat-no" title="statement not covered" >                p0 = {};</span>
            }
<span class="cstat-no" title="statement not covered" >            return new metadata_1.ViewMetadata({</span>
                templateUrl: p0['templateUrl'],
                template: p0['template'],
                directives: p0['directives'],
                pipes: p0['pipes'],
...
<span class="cstat-no" title="statement not covered" >        conversionMap.set(this.getStaticType(core_metadata, 'Attribute'), <span class="fstat-no" title="function not covered" >function (moduleContext, expression) {</span> <span class="cstat-no" title="statement not covered" >return new metadata_1.AttributeMetadata(_this.getDecoratorParameter(moduleContext, expression, 0)); </span>});</span>
<span class="cstat-no" title="statement not covered" >        conversionMap.set(this.getStaticType(core_metadata, 'Query'), <span class="fstat-no" title="function not covered" >function (moduleContext, expression) {</span></span>
<span class="cstat-no" title="statement not covered" >            var p0 = _this.getDecoratorParameter(moduleContext, expression, 0);</span>
<span class="cstat-no" title="statement not covered" >            var p1 = _this.getDecoratorParameter(moduleContext, expression, 1);</span>
<span class="cstat-no" title="statement not covered" >            if (!lang_1.isPresent(p1)) {</span>
<span class="cstat-no" title="statement not covered" >                p1 = {};</span>
            }
<span class="cstat-no" title="statement not covered" >            return new metadata_1.QueryMetadata(p0, { descendants: p1.descendants, first: p1.first });</span>
        });
<span class="cstat-no" title="statement not covered" >        conversionMap.set(this.getStaticType(core_metadata, 'ContentChildren'), <span class="fstat-no" title="function not covered" >function (moduleContext, expression) {</span> <span class="cstat-no" title="statement not covered" >return new metadata_1.ContentChildrenMetadata(_this.getDecoratorParameter(moduleContext, expression, 0)); </span>});</span>
<span class="cstat-no" title="statement not covered" >        conversionMap.set(this.getStaticType(core_metadata, 'ContentChild'), <span class="fstat-no" title="function not covered" >function (moduleContext, expression) {</span> <span class="cstat-no" title="statement not covered" >return new metadata_1.ContentChildMetadata(_this.getDecoratorParameter(moduleContext, expression, 0)); </span>});</span>
<span class="cstat-no" title="statement not covered" >        conversionMap.set(this.getStaticType(core_metadata, 'ViewChildren'), <span class="fstat-no" title="function not covered" >function (moduleContext, expression) {</span> <span class="cstat-no" title="statement not covered" >return new metadata_1.ViewChildrenMetadata(_this.getDecoratorParameter(moduleContext, expression, 0)); </span>});</span>
<span class="cstat-no" title="statement not covered" >        conversionMap.set(this.getStaticType(core_metadata, 'ViewChild'), <span class="fstat-no" title="function not covered" >function (moduleContext, expression) {</span> <span class="cstat-no" title="statement not covered" >return new metadata_1.ViewChildMetadata(_this.getDecoratorParameter(moduleContext, expression, 0)); </span>});</span>
<span class="cstat-no" title="statement not covered" >        conversionMap.set(this.getStaticType(core_metadata, 'ViewQuery'), <span class="fstat-no" title="function not covered" >function (moduleContext, expression) {</span></span>
<span class="cstat-no" title="statement not covered" >            var p0 = _this.getDecoratorParameter(moduleContext, expression, 0);</span>
<span class="cstat-no" title="statement not covered" >            var p1 = _this.getDecoratorParameter(moduleContext, expression, 1);</span>
<span class="cstat-no" title="statement not covered" >            if (!lang_1.isPresent(p1)) {</span>
<span class="cstat-no" title="statement not covered" >                p1 = {};</span>
            }
<span class="cstat-no" title="statement not covered" >            return new metadata_1.ViewQueryMetadata(p0, {</span>
                descendants: p1['descendants'],
                first: p1['first'],
            });
        });
<span class="cstat-no" title="statement not covered" >        conversionMap.set(this.getStaticType(core_metadata, 'Pipe'), <span class="fstat-no" title="function not covered" >function (moduleContext, expression) {</span></span>
<span class="cstat-no" title="statement not covered" >            var p0 = _this.getDecoratorParameter(moduleContext, expression, 0);</span>
<span class="cstat-no" title="statement not covered" >            if (!lang_1.isPresent(p0)) {</span>
<span class="cstat-no" title="statement not covered" >                p0 = {};</span>
            }
<span class="cstat-no" title="statement not covered" >            return new metadata_1.PipeMetadata({</span>
                name: p0['name'],
                pure: p0['pure'],
            });
        });
<span class="cstat-no" title="statement not covered" >        conversionMap.set(this.getStaticType(core_metadata, 'HostBinding'), <span class="fstat-no" title="function not covered" >function (moduleContext, expression) {</span> <span class="cstat-no" title="statement not covered" >return new metadata_1.HostBindingMetadata(_this.getDecoratorParameter(moduleContext, expression, 0)); </span>});</span>
<span class="cstat-no" title="statement not covered" >        conversionMap.set(this.getStaticType(core_metadata, 'HostListener'), <span class="fstat-no" title="function not covered" >function (moduleContext, expression) {</span> <span class="cstat-no" title="statement not covered" >return new metadata_1.HostListenerMetadata(_this.getDecoratorParameter(moduleContext, expression, 0), _this.getDecoratorParameter(moduleContext, expression, 1)); </span>});</span>
<span class="cstat-no" title="statement not covered" >        return null;</span>
    };
<span class="cstat-no" title="statement not covered" >    StaticReflector.prototype.convertKnownDecorator = <span class="fstat-no" title="function not covered" >function (moduleContext, expression) {</span></span>
<span class="cstat-no" title="statement not covered" >        var converter = this.conversionMap.get(this.getDecoratorType(moduleContext, expression));</span>
<span class="cstat-no" title="statement not covered" >        if (lang_1.isPresent(converter))</span>
<span class="cstat-no" title="statement not covered" >            return converter(moduleContext, expression);</span>
<span class="cstat-no" title="statement not covered" >        return null;</span>
    };
<span class="cstat-no" title="statement not covered" >    StaticReflector.prototype.getDecoratorType = <span class="fstat-no" title="function not covered" >function (moduleContext, expression) {</span></span>
<span class="cstat-no" title="statement not covered" >        if (isMetadataSymbolicCallExpression(expression)) {</span>
<span class="cstat-no" title="statement not covered" >            var target = expression['expression'];</span>
<span class="cstat-no" title="statement not covered" >            if (isMetadataSymbolicReferenceExpression(target)) {</span>
<span class="cstat-no" title="statement not covered" >                var moduleId = this.host.resolveModule(target['module'], moduleContext);</span>
<span class="cstat-no" title="statement not covered" >                return this.getStaticType(moduleId, target['name']);</span>
            }
        }
<span class="cstat-no" title="statement not covered" >        return null;</span>
    };
<span class="cstat-no" title="statement not covered" >    StaticReflector.prototype.getDecoratorParameter = <span class="fstat-no" title="function not covered" >function (moduleContext, expression, index) {</span></span>
<span class="cstat-no" title="statement not covered" >        if (isMetadataSymbolicCallExpression(expression) &amp;&amp; lang_1.isPresent(expression['arguments']) &amp;&amp;</span>
            expression['arguments'].length &lt;= index + 1) {
<span class="cstat-no" title="statement not covered" >            return this.simplify(moduleContext, expression['arguments'][index]);</span>
        }
<span class="cstat-no" title="statement not covered" >        return null;</span>
    };
<span class="cstat-no" title="statement not covered" >    StaticReflector.prototype.getPropertyMetadata = <span class="fstat-no" title="function not covered" >function (moduleContext, value) {</span></span>
<span class="cstat-no" title="statement not covered" >        var _this = this;</span>
<span class="cstat-no" title="statement not covered" >        if (lang_1.isPresent(value)) {</span>
<span class="cstat-no" title="statement not covered" >            var result_1 = {};</span>
<span class="cstat-no" title="statement not covered" >            collection_1.StringMapWrapper.forEach(value, <span class="fstat-no" title="function not covered" >function (value, name) {</span></span>
<span class="cstat-no" title="statement not covered" >                var data = _this.getMemberData(moduleContext, value);</span>
<span class="cstat-no" title="statement not covered" >                if (lang_1.isPresent(data)) {</span>
<span class="cstat-no" title="statement not covered" >                    var propertyData = data.filter(<span class="fstat-no" title="function not covered" >function (d) {</span> <span class="cstat-no" title="statement not covered" >return d['kind'] == "property"; </span>})</span>
                        .map(<span class="fstat-no" title="function not covered" >function (d) {</span> <span class="cstat-no" title="statement not covered" >return d['directives']; </span>})
                        .reduce(<span class="fstat-no" title="function not covered" >function (p, c) {</span> <span class="cstat-no" title="statement not covered" >return p.concat(c); </span>}, []);
<span class="cstat-no" title="statement not covered" >                    if (propertyData.length != 0) {</span>
<span class="cstat-no" title="statement not covered" >                        collection_1.StringMapWrapper.set(result_1, name, propertyData);</span>
                    }
                }
            });
<span class="cstat-no" title="statement not covered" >            return result_1;</span>
        }
<span class="cstat-no" title="statement not covered" >        return {};</span>
    };
    // clang-format off
<span class="cstat-no" title="statement not covered" >    StaticReflector.prototype.getMemberData = <span class="fstat-no" title="function not covered" >function (moduleContext, member) {</span></span>
<span class="cstat-no" title="statement not covered" >        var _this = this;</span>
        // clang-format on
<span class="cstat-no" title="statement not covered" >        var result = [];</span>
<span class="cstat-no" title="statement not covered" >        if (lang_1.isPresent(member)) {</span>
<span class="cstat-no" title="statement not covered" >            for (var _i = 0, member_1 = member; _i &lt; member_1.length; _i++) {</span>
<span class="cstat-no" title="statement not covered" >                var item = member_1[_i];</span>
<span class="cstat-no" title="statement not covered" >                result.push({</span>
                    ...
                    directives: lang_1.isPresent(item['decorators']) ?
                        item['decorators']
                            .map(<span class="fstat-no" title="function not covered" >function (decorator) {</span> <span class="cstat-no" title="statement not covered" >return _this.convertKnownDecorator(moduleContext, decorator); </span>})
                            .filter(<span class="fstat-no" title="function not covered" >function (d) {</span> <span class="cstat-no" title="statement not covered" >return lang_1.isPresent(d); </span>}) :
                        null
                });
            }
        }
<span class="cstat-no" title="statement not covered" >        return result;</span>
    ...
    /** @internal */
<span class="cstat-no" title="statement not covered" >    StaticReflector.prototype.simplify = <span class="fstat-no" title="function not covered" >function (moduleContext, value) {</span></span>
<span class="cstat-no" title="statement not covered" >        var _this = this;</span>
<span class="fstat-no" title="function not covered" >        function simplify(expression) {</span>
<span class="cstat-no" title="statement not covered" >            if (lang_1.isPrimitive(expression)) {</span>
<span class="cstat-no" title="statement not covered" >                return expression;</span>
            }
<span class="cstat-no" title="statement not covered" >            if (lang_1.isArray(expression)) {</span>
<span class="cstat-no" title="statement not covered" >                var result = [];</span>
<span class="cstat-no" title="statement not covered" >                for (var _i = 0, _a = expression; _i &lt; _a.length; _i++) {</span>
<span class="cstat-no" title="statement not covered" >                    var item = _a[_i];</span>
<span class="cstat-no" title="statement not covered" >                    result.push(simplify(item));</span>
                }
<span class="cstat-no" title="statement not covered" >                return result;</span>
            }
<span class="cstat-no" title="statement not covered" >            if (lang_1.isPresent(expression)) {</span>
<span class="cstat-no" title="statement not covered" >                if (lang_1.isPresent(expression['__symbolic'])) {</span>
<span class="cstat-no" title="statement not covered" >                    switch (expression['__symbolic']) {</span>
                        case "binop":
<span class="cstat-no" title="statement not covered" >                            var left = simplify(expression['left']);</span>
<span class="cstat-no" title="statement not covered" >                            var right = simplify(expression['right']);</span>
<span class="cstat-no" title="statement not covered" >                            switch (expression['operator']) {</span>
                                case '&amp;&amp;':
...
<span class="cstat-no" title="statement not covered" >                            return null;</span>
                        case "pre":
<span class="cstat-no" title="statement not covered" >                            var operand = simplify(expression['operand']);</span>
<span class="cstat-no" title="statement not covered" >                            switch (expression['operator']) {</span>
                                case '+':
...
<span class="cstat-no" title="statement not covered" >                            return null;</span>
                        case "index":
<span class="cstat-no" title="statement not covered" >                            var indexTarget = simplify(expression['expression']);</span>
<span class="cstat-no" title="statement not covered" >                            var index = simplify(expression['index']);</span>
<span class="cstat-no" title="statement not covered" >                            if (lang_1.isPresent(indexTarget) &amp;&amp; lang_1.isPrimitive(index))</span>
<span class="cstat-no" title="statement not covered" >                                return indexTarget[index];</span>
<span class="cstat-no" title="statement not covered" >                            return null;</span>
                        case "select":
<span class="cstat-no" title="statement not covered" >                            var selectTarget = simplify(expression['expression']);</span>
<span class="cstat-no" title="statement not covered" >                            var member = simplify(expression['member']);</span>
<span class="cstat-no" title="statement not covered" >                            if (lang_1.isPresent(selectTarget) &amp;&amp; lang_1.isPrimitive(member))</span>
<span class="cstat-no" title="statement not covered" >                                return selectTarget[member];</span>
<span class="cstat-no" title="statement not covered" >                            return null;</span>
                        case "reference":
<span class="cstat-no" title="statement not covered" >                            var referenceModuleName = _this.host.resolveModule(expression['module'], moduleContext);</span>
<span class="cstat-no" title="statement not covered" >                            var referenceModule = _this.getModuleMetadata(referenceModuleName);</span>
<span class="cstat-no" title="statement not covered" >                            var referenceValue = referenceModule['metadata'][expression['name']];</span>
<span class="cstat-no" title="statement not covered" >                            if (isClassMetadata(referenceValue)) {</span>
                                // Convert to a pseudo type
<span class="cstat-no" title="statement not covered" >                                return _this.getStaticType(referenceModuleName, expression['name']);</span>
                            }
<span class="cstat-no" title="statement not covered" >                            return _this.simplify(referenceModuleName, referenceValue);</span>
                        case "call":
<span class="cstat-no" title="statement not covered" >                            return null;</span>
                    }
<span class="cstat-no" title="statement not covered" >                    return null;</span>
                }
<span class="cstat-no" title="statement not covered" >                var result_2 = {};</span>
<span class="cstat-no" title="statement not covered" >                collection_1.StringMapWrapper.forEach(expression, <span class="fstat-no" title="function not covered" >function (value, name) {</span> <span class="cstat-no" title="statement not covered" >result_2[name] = simplify(value); </span>});</span>
<span class="cstat-no" title="statement not covered" >                return result_2;</span>
            }
<span class="cstat-no" title="statement not covered" >            return null;</span>
        }
<span class="cstat-no" title="statement not covered" >        return simplify(value);</span>
    };
    /**
     * @param module an absolute path to a module file.
     */
<span class="cstat-no" title="statement not covered" >    StaticReflector.prototype.getModuleMetadata = <span class="fstat-no" title="function not covered" >function (module) {</span></span>
<span class="cstat-no" title="statement not covered" >        var moduleMetadata = this.metadataCache.get(module);</span>
<span class="cstat-no" title="statement not covered" >        if (!lang_1.isPresent(moduleMetadata)) {</span>
<span class="cstat-no" title="statement not covered" >            moduleMetadata = this.host.getMetadataFor(module);</span>
<span class="cstat-no" title="statement not covered" >            if (!lang_1.isPresent(moduleMetadata)) {</span>
<span class="cstat-no" title="statement not covered" >                moduleMetadata = { __symbolic: "module", module: module, metadata: {} };</span>
            }
<span class="cstat-no" title="statement not covered" >            this.metadataCache.set(module, moduleMetadata);</span>
        }
<span class="cstat-no" title="statement not covered" >        return moduleMetadata;</span>
    };
<span class="cstat-no" title="statement not covered" >    StaticReflector.prototype.getTypeMetadata = <span class="fstat-no" title="function not covered" >function (type) {</span></span>
<span class="cstat-no" title="statement not covered" >        var moduleMetadata = this.getModuleMetadata(type.moduleId);</span>
<span class="cstat-no" title="statement not covered" >        var result = moduleMetadata['metadata'][type.name];</span>
<span class="cstat-no" title="statement not covered" >        if (!lang_1.isPresent(result)) {</span>
<span class="cstat-no" title="statement not covered" >            result = { __symbolic: "class" };</span>
        }
<span class="cstat-no" title="statement not covered" >        return result;</span>
    };
<span class="cstat-no" title="statement not covered" >    return StaticReflector;</span>
}());
<span class="cstat-no" title="statement not covered" >exports.StaticReflector = StaticReflector;</span>
<span class="fstat-no" title="function not covered" >function isMetadataSymbolicCallExpression(expression) {</span>
<span class="cstat-no" title="statement not covered" >    return !lang_1.isPrimitive(expression) &amp;&amp; !lang_1.isArray(expression) &amp;&amp; expression['__symbolic'] == 'call';</span>
}
<span class="fstat-no" title="function not covered" >function isMetadataSymbolicReferenceExpression(expression) {</span>
<span class="cstat-no" title="statement not covered" >    return !lang_1.isPrimitive(expression) &amp;&amp; !lang_1.isArray(expression) &amp;&amp;</span>
        expression['__symbolic'] == 'reference';
}
<span class="fstat-no" title="function not covered" >function isClassMetadata(expression) {</span>
<span class="cstat-no" title="statement not covered" >    return !lang_1.isPrimitive(expression) &amp;&amp; !lang_1.isArray(expression) &amp;&amp; expression['__symbolic'] == 'class';</span>
}
