...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-angular2/node_modules/angular2/src/facade/lang.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-angular2/node_modules/angular2/src/facade/lang.js</span></h1>
    <h2>
        
        Statements: <span class="metric">48.35% <small>(176 / 364)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">6.78% <small>(8 / 118)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">12.87% <small>(13 / 101)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">52.44% <small>(172 / 328)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-angular2/node_modules/angular2/src/facade/</a> &#187; lang.js</div>
</div>
<div class="body">
...
<span class="missing-if-branch" title="else path not taken" >E</span>if (typeof window === 'undefined') {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof WorkerGlobalScope !== 'undefined' &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >self instanceof WorkerGlobalScope)</span> {
...
<span class="fstat-no" title="function not covered" >function scheduleMicroTask(fn) {</span>
<span class="cstat-no" title="statement not covered" >    Zone.current.scheduleMicroTask('scheduleMicrotask', fn);</span>
}
...
<span class="fstat-no" title="function not covered" >function getTypeNameForDebugging(type) {</span>
...
<span class="cstat-no" title="statement not covered" >    return typeof type;</span>
}
...
<span class="fstat-no" title="function not covered" >function lockMode() {</span>
<span class="cstat-no" title="statement not covered" >    _modeLocked = true;</span>
}
 ...
 */
<span class="fstat-no" title="function not covered" >function enableProdMode() {</span>
<span class="cstat-no" title="statement not covered" >    if (_modeLocked) {</span>
        // Cannot use BaseException as that ends up importing from facade/lang.
<span class="cstat-no" title="statement not covered" >        throw 'Cannot enable prod mode after platform setup.';</span>
    }
<span class="cstat-no" title="statement not covered" >    _devMode = false;</span>
}
exports.enableProdMode = enableProdMode;
<span class="fstat-no" title="function not covered" >function assertionsEnabled() {</span>
<span class="cstat-no" title="statement not covered" >    return _devMode;</span>
}
exports.assertionsEnabled = assertionsEnabled;
// TODO: remove calls to assert in production environment
// Note: Can't just export this and import in in other files
// as `assert` is a reserved keyword in Dart
_global.assert = <span class="fstat-no" title="function not covered" >function assert(condition) {</span>
    // TODO: to be fixed properly via #2830, noop for now
};
// This function is needed only to properly support Dart's const expressions
// see https://github.com/angular/ts2dart/pull/151 for more info
<span class="fstat-no" title="function not covered" >function CONST_EXPR(expr) {</span>
...
<span class="fstat-no" title="function not covered" >function isType(obj) {</span>
<span class="cstat-no" title="statement not covered" >    return isFunction(obj);</span>
}
exports.isType = isType;
<span class="fstat-no" title="function not covered" >function isStringMap(obj) {</span>
...
<span class="cstat-no" title="statement not covered" >    return obj instanceof _global.Promise;</span>
}
...
<span class="cstat-no" title="statement not covered" >    return obj instanceof exports.Date &amp;&amp; !isNaN(obj.valueOf());</span>
}
...
<span class="cstat-no" title="statement not covered" >    if (token === undefined || token === null) {</span>
<span class="cstat-no" title="statement not covered" >        return '' + token;</span>
    }
<span class="cstat-no" title="statement not covered" >    if (token.name) {</span>
<span class="cstat-no" title="statement not covered" >        return token.name;</span>
    }
<span class="cstat-no" title="statement not covered" >    if (token.overriddenName) {</span>
<span class="cstat-no" title="statement not covered" >        return token.overriddenName;</span>
    }
<span class="cstat-no" title="statement not covered" >    var res = token.toString();</span>
<span class="cstat-no" title="statement not covered" >    var newLineIndex = res.indexOf("\n");</span>
<span class="cstat-no" title="statement not covered" >    return (newLineIndex === -1) ? res : res.substring(0, newLineIndex);</span>
}
exports.stringify = stringify;
// serialize / deserialize enum exist only for consistency with dart API
// enums in typescript don't need to be serialized
<span class="fstat-no" title="function not covered" >function serializeEnum(val) {</span>
<span class="cstat-no" title="statement not covered" >    return val;</span>
}
exports.serializeEnum = serializeEnum;
<span class="fstat-no" title="function not covered" >function deserializeEnum(val, values) {</span>
<span class="cstat-no" title="statement not covered" >    return val;</span>
}
exports.deserializeEnum = deserializeEnum;
<span class="fstat-no" title="function not covered" >function resolveEnumToken(enumValue, val) {</span>
<span class="cstat-no" title="statement not covered" >    return enumValue[val];</span>
}
exports.resolveEnumToken = resolveEnumToken;
var StringWrapper = (function () {
<span class="fstat-no" title="function not covered" >    function StringWrapper() {</span>
    }
    StringWrapper.fromCharCode = <span class="fstat-no" title="function not covered" >function (code) {</span> <span class="cstat-no" title="statement not covered" >return String.fromCharCode(code); </span>};
    StringWrapper.charCodeAt = <span class="fstat-no" title="function not covered" >function (s, index) {</span> <span class="cstat-no" title="statement not covered" >return s.charCodeAt(index); </span>};
    StringWrapper.split = <span class="fstat-no" title="function not covered" >function (s, regExp) {</span> <span class="cstat-no" title="statement not covered" >return s.split(regExp); </span>};
    StringWrapper.equals = <span class="fstat-no" title="function not covered" >function (s, s2) {</span> <span class="cstat-no" title="statement not covered" >return s === s2; </span>};
    StringWrapper.stripLeft = <span class="fstat-no" title="function not covered" >function (s, charVal) {</span>
...
<span class="cstat-no" title="statement not covered" >                if (s[i] != charVal)</span>
<span class="cstat-no" title="statement not covered" >                    break;</span>
<span class="cstat-no" title="statement not covered" >                pos++;</span>
            }
<span class="cstat-no" title="statement not covered" >            s = s.substring(pos);</span>
        }
<span class="cstat-no" title="statement not covered" >        return s;</span>
    };
    StringWrapper.stripRight = <span class="fstat-no" title="function not covered" >function (s, charVal) {</span>
<span class="cstat-no" title="statement not covered" >        if (s &amp;&amp; s.length) {</span>
<span class="cstat-no" title="statement not covered" >            var pos = s.length;</span>
<span class="cstat-no" title="statement not covered" >            for (var i = s.length - 1; i &gt;= 0; i--) {</span>
<span class="cstat-no" title="statement not covered" >                if (s[i] != charVal)</span>
<span class="cstat-no" title="statement not covered" >                    break;</span>
<span class="cstat-no" title="statement not covered" >                pos--;</span>
            }
<span class="cstat-no" title="statement not covered" >            s = s.substring(0, pos);</span>
        }
<span class="cstat-no" title="statement not covered" >        return s;</span>
    };
    StringWrapper.replace = <span class="fstat-no" title="function not covered" >function (s, from, replace) {</span>
<span class="cstat-no" title="statement not covered" >        return s.replace(from, replace);</span>
    };
    StringWrapper.replaceAll = <span class="fstat-no" title="function not covered" >function (s, from, replace) {</span>
<span class="cstat-no" title="statement not covered" >        return s.replace(from, replace);</span>
    };
    StringWrapper.slice = <span class="fstat-no" title="function not covered" >function (s, from, to) {</span>
...
<span class="cstat-no" title="statement not covered" >        return s.slice(from, to === null ? undefined : to);</span>
    };
    StringWrapper.replaceAllMapped = <span class="fstat-no" title="function not covered" >function (s, from, cb) {</span>
<span class="cstat-no" title="statement not covered" >        return s.replace(from, <span class="fstat-no" title="function not covered" >function () {</span></span>
...
<span class="cstat-no" title="statement not covered" >                matches[_i - 0] = arguments[_i];</span>
            }
            // Remove offset &amp; string from the result array
<span class="cstat-no" title="statement not covered" >            matches.splice(-2, 2);</span>
            // The callback receives match, p1, ..., pn
<span class="cstat-no" title="statement not covered" >            return cb(matches);</span>
        });
    };
    StringWrapper.contains = <span class="fstat-no" title="function not covered" >function (s, substr) {</span> <span class="cstat-no" title="statement not covered" >return s.indexOf(substr) != -1; </span>};
    StringWrapper.compare = <span class="fstat-no" title="function not covered" >function (a, b) {</span>
...
<span class="fstat-no" title="function not covered" >    function StringJoiner(parts) {</span>
<span class="cstat-no" title="statement not covered" >        if (parts === void 0) { <span class="cstat-no" title="statement not covered" >parts = []; </span>}</span>
<span class="cstat-no" title="statement not covered" >        this.parts = parts;</span>
    }
    StringJoiner.prototype.add = <span class="fstat-no" title="function not covered" >function (part) {</span> <span class="cstat-no" title="statement not covered" >this.parts.push(part); </span>};
    StringJoiner.prototype.toString = <span class="fstat-no" title="function not covered" >function () {</span> <span class="cstat-no" title="statement not covered" >return this.parts.join(""); </span>};
    return StringJoiner;
}());
exports.StringJoiner = StringJoiner;
var NumberParseError = (function (_super) {
    __extends(NumberParseError, _super);
<span class="fstat-no" title="function not covered" >    function NumberParseError(message) {</span>
...
<span class="cstat-no" title="statement not covered" >        this.message = message;</span>
    ...
    NumberParseError.prototype.toString = <span class="fstat-no" title="function not covered" >function () {</span> <span class="cstat-no" title="statement not covered" >return this.message; </span>};
    return NumberParseError;
}(Error));
exports.NumberParseError = NumberParseError;
var NumberWrapper = (function () {
<span class="fstat-no" title="function not covered" >    function NumberWrapper() {</span>
    }
    NumberWrapper.toFixed = <span class="fstat-no" title="function not covered" >function (n, fractionDigits) {</span> <span class="cstat-no" title="statement not covered" >return n.toFixed(fractionDigits); </span>};
    NumberWrapper.equal = <span class="fstat-no" title="function not covered" >function (a, b) {</span> <span class="cstat-no" title="statement not covered" >return a === b; </span>};
    NumberWrapper.parseIntAutoRadix = <span class="fstat-no" title="function not covered" >function (text) {</span>
<span class="cstat-no" title="statement not covered" >        var result = parseInt(text);</span>
<span class="cstat-no" title="statement not covered" >        if (isNaN(result)) {</span>
<span class="cstat-no" title="statement not covered" >            throw new NumberParseError("Invalid integer literal when parsing " + text);</span>
        }
<span class="cstat-no" title="statement not covered" >        return result;</span>
    };
    NumberWrapper.parseInt = <span class="fstat-no" title="function not covered" >function (text, radix) {</span>
<span class="cstat-no" title="statement not covered" >        if (radix == 10) {</span>
<span class="cstat-no" title="statement not covered" >            if (/^(\-|\+)?[0-9]+$/.test(text)) {</span>
<span class="cstat-no" title="statement not covered" >                return parseInt(text, radix);</span>
            }
        }
        else <span class="cstat-no" title="statement not covered" >if (radix == 16) {</span>
<span class="cstat-no" title="statement not covered" >            if (/^(\-|\+)?[0-9ABCDEFabcdef]+$/.test(text)) {</span>
<span class="cstat-no" title="statement not covered" >                return parseInt(text, radix);</span>
            }
        }
        else {
<span class="cstat-no" title="statement not covered" >            var result = parseInt(text, radix);</span>
<span class="cstat-no" title="statement not covered" >            if (!isNaN(result)) {</span>
<span class="cstat-no" title="statement not covered" >                return result;</span>
            }
        }
<span class="cstat-no" title="statement not covered" >        throw new NumberParseError("Invalid integer literal when parsing " + text + " in base " +</span>
            radix);
    };
    // TODO: NaN is a valid literal but is returned by parseFloat to indicate an error.
    NumberWrapper.parseFloat = <span class="fstat-no" title="function not covered" >function (text) {</span> <span class="cstat-no" title="statement not covered" >return parseFloat(text); </span>};
    Object.defineProperty(NumberWrapper, "NaN", {
        get: <span class="fstat-no" title="function not covered" >function () {</span> <span class="cstat-no" title="statement not covered" >return NaN; </span>},
        enumerable: true,
        configurable: true
    });
    NumberWrapper.isNaN = <span class="fstat-no" title="function not covered" >function (value) {</span> <span class="cstat-no" title="statement not covered" >return isNaN(value); </span>};
    NumberWrapper.isInteger = <span class="fstat-no" title="function not covered" >function (value) {</span> <span class="cstat-no" title="statement not covered" >return Number.isInteger(value); </span>};
    return NumberWrapper;
}());
exports.NumberWrapper = NumberWrapper;
exports.RegExp = _global.RegExp;
var RegExpWrapper = (function () {
<span class="fstat-no" title="function not covered" >    function RegExpWrapper() {</span>
    }
    RegExpWrapper.create = <span class="fstat-no" title="function not covered" >function (regExpStr, flags) {</span>
<span class="cstat-no" title="statement not covered" >        if (flags === void 0) { <span class="cstat-no" title="statement not covered" >flags = ''; </span>}</span>
<span class="cstat-no" title="statement not covered" >        flags = flags.replace(/g/g, '');</span>
<span class="cstat-no" title="statement not covered" >        return new _global.RegExp(regExpStr, flags + 'g');</span>
    };
    RegExpWrapper.firstMatch = <span class="fstat-no" title="function not covered" >function (regExp, input) {</span>
        // Reset multimatch regex state
<span class="cstat-no" title="statement not covered" >        regExp.lastIndex = 0;</span>
<span class="cstat-no" title="statement not covered" >        return regExp.exec(input);</span>
    };
    RegExpWrapper.test = <span class="fstat-no" title="function not covered" >function (regExp, input) {</span>
<span class="cstat-no" title="statement not covered" >        regExp.lastIndex = 0;</span>
<span class="cstat-no" title="statement not covered" >        return regExp.test(input);</span>
    };
    RegExpWrapper.matcher = <span class="fstat-no" title="function not covered" >function (regExp, input) {</span>
        // Reset regex state for the case
        // someone did not loop over all matches
        // last time.
<span class="cstat-no" title="statement not covered" >        regExp.lastIndex = 0;</span>
<span class="cstat-no" title="statement not covered" >        return { re: regExp, input: input };</span>
    };
    RegExpWrapper.replaceAll = <span class="fstat-no" title="function not covered" >function (regExp, input, replace) {</span>
<span class="cstat-no" title="statement not covered" >        var c = regExp.exec(input);</span>
...
<span class="cstat-no" title="statement not covered" >            res += input.substring(prev, c.index);</span>
<span class="cstat-no" title="statement not covered" >            res += replace(c);</span>
<span class="cstat-no" title="statement not covered" >            prev = c.index + c[0].length;</span>
<span class="cstat-no" title="statement not covered" >            regExp.lastIndex = prev;</span>
<span class="cstat-no" title="statement not covered" >            c = regExp.exec(input);</span>
        }
<span class="cstat-no" title="statement not covered" >        res += input.substring(prev);</span>
...
<span class="fstat-no" title="function not covered" >    function RegExpMatcherWrapper() {</span>
    }
    RegExpMatcherWrapper.next = <span class="fstat-no" title="function not covered" >function (matcher) {</span>
<span class="cstat-no" title="statement not covered" >        return matcher.re.exec(matcher.input);</span>
    };
    return RegExpMatcherWrapper;
}());
exports.RegExpMatcherWrapper = RegExpMatcherWrapper;
var FunctionWrapper = (function () {
<span class="fstat-no" title="function not covered" >    function FunctionWrapper() {</span>
    }
    FunctionWrapper.apply = <span class="fstat-no" title="function not covered" >function (fn, posArgs) {</span> <span class="cstat-no" title="statement not covered" >return fn.apply(null, posArgs); </span>};
    return FunctionWrapper;
}());
exports.FunctionWrapper = FunctionWrapper;
// JS has NaN !== NaN
<span class="fstat-no" title="function not covered" >function looseIdentical(a, b) {</span>
<span class="cstat-no" title="statement not covered" >    return a === b || typeof a === "number" &amp;&amp; typeof b === "number" &amp;&amp; isNaN(a) &amp;&amp; isNaN(b);</span>
}
exports.looseIdentical = looseIdentical;
// JS considers NaN is the same as NaN for map Key (while NaN !== NaN otherwise)
// see https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Map
<span class="fstat-no" title="function not covered" >function getMapKey(value) {</span>
<span class="cstat-no" title="statement not covered" >    return value;</span>
}
exports.getMapKey = getMapKey;
<span class="fstat-no" title="function not covered" >function normalizeBlank(obj) {</span>
<span class="cstat-no" title="statement not covered" >    return isBlank(obj) ? null : obj;</span>
}
exports.normalizeBlank = normalizeBlank;
<span class="fstat-no" title="function not covered" >function normalizeBool(obj) {</span>
<span class="cstat-no" title="statement not covered" >    return isBlank(obj) ? false : obj;</span>
}
...
exports.print = print;
<span class="fstat-no" title="function not covered" >function warn(obj) {</span>
<span class="cstat-no" title="statement not covered" >    console.warn(obj);</span>
}
exports.warn = warn;
...
<span class="fstat-no" title="function not covered" >    function Json() {</span>
    ...
    Json.parse = <span class="fstat-no" title="function not covered" >function (s) {</span> <span class="cstat-no" title="statement not covered" >return _global.JSON.parse(s); </span>};
    Json.stringify = <span class="fstat-no" title="function not covered" >function (data) {</span>
        // Dart doesn't take 3 arguments
<span class="cstat-no" title="statement not covered" >        return _global.JSON.stringify(data, null, 2);</span>
    };
    return Json;
}());
exports.Json = Json;
var DateWrapper = (function () {
<span class="fstat-no" title="function not covered" >    function DateWrapper() {</span>
    }
    DateWrapper.create = <span class="fstat-no" title="function not covered" >function (year, month, day, hour, minutes, seconds, milliseconds) {</span>
<span class="cstat-no" title="statement not covered" >        if (month === void 0) { <span class="cstat-no" title="statement not covered" >month = 1; </span>}</span>
<span class="cstat-no" title="statement not covered" >        if (day === void 0) { <span class="cstat-no" title="statement not covered" >day = 1; </span>}</span>
<span class="cstat-no" title="statement not covered" >        if (hour === void 0) { <span class="cstat-no" title="statement not covered" >hour = 0; </span>}</span>
<span class="cstat-no" title="statement not covered" >        if (minutes === void 0) { <span class="cstat-no" title="statement not covered" >minutes = 0; </span>}</span>
<span class="cstat-no" title="statement not covered" >        if (seconds === void 0) { <span class="cstat-no" title="statement not covered" >seconds = 0; </span>}</span>
<span class="cstat-no" title="statement not covered" >        if (milliseconds === void 0) { <span class="cstat-no" title="statement not covered" >milliseconds = 0; </span>}</span>
<span class="cstat-no" title="statement not covered" >        return new exports.Date(year, month - 1, day, hour, minutes, seconds, milliseconds);</span>
    };
    DateWrapper.fromISOString = <span class="fstat-no" title="function not covered" >function (str) {</span> <span class="cstat-no" title="statement not covered" >return new exports.Date(str); </span>};
    DateWrapper.fromMillis = <span class="fstat-no" title="function not covered" >function (ms) {</span> <span class="cstat-no" title="statement not covered" >return new exports.Date(ms); </span>};
    DateWrapper.toMillis = <span class="fstat-no" title="function not covered" >function (date) {</span> <span class="cstat-no" title="statement not covered" >return date.getTime(); </span>};
    DateWrapper.now = <span class="fstat-no" title="function not covered" >function () {</span> <span class="cstat-no" title="statement not covered" >return new exports.Date(); </span>};
    DateWrapper.toJson = <span class="fstat-no" title="function not covered" >function (date) {</span> <span class="cstat-no" title="statement not covered" >return date.toJSON(); </span>};
    return DateWrapper;
}());
...
<span class="cstat-no" title="statement not covered" >        if (obj.hasOwnProperty(name) &amp;&amp; isPresent(obj[name])) {</span>
...
<span class="fstat-no" title="function not covered" >function evalExpression(sourceUrl, expr, declarations, vars) {</span>
<span class="cstat-no" title="statement not covered" >    var fnBody = declarations + "\nreturn " + expr + "\n//# sourceURL=" + sourceUrl;</span>
<span class="cstat-no" title="statement not covered" >    var fnArgNames = [];</span>
<span class="cstat-no" title="statement not covered" >    var fnArgValues = [];</span>
<span class="cstat-no" title="statement not covered" >    for (var argName in vars) {</span>
<span class="cstat-no" title="statement not covered" >        fnArgNames.push(argName);</span>
<span class="cstat-no" title="statement not covered" >        fnArgValues.push(vars[argName]);</span>
    }
<span class="cstat-no" title="statement not covered" >    return new (Function.bind.apply(Function, [void 0].concat(fnArgNames.concat(fnBody))))().apply(void 0, fnArgValues);</span>
}
exports.evalExpression = evalExpression;
<span class="fstat-no" title="function not covered" >function isPrimitive(obj) {</span>
<span class="cstat-no" title="statement not covered" >    return !isJsObject(obj);</span>
}
exports.isPrimitive = isPrimitive;
<span class="fstat-no" title="function not covered" >function hasConstructor(value, type) {</span>
<span class="cstat-no" title="statement not covered" >    return value.constructor === type;</span>
}
exports.hasConstructor = hasConstructor;
<span class="fstat-no" title="function not covered" >function bitWiseOr(values) {</span>
<span class="cstat-no" title="statement not covered" >    return values.reduce(<span class="fstat-no" title="function not covered" >function (a, b) {</span> <span class="cstat-no" title="statement not covered" >return a | b; </span>});</span>
}
exports.bitWiseOr = bitWiseOr;
<span class="fstat-no" title="function not covered" >function bitWiseAnd(values) {</span>
<span class="cstat-no" title="statement not covered" >    return values.reduce(<span class="fstat-no" title="function not covered" >function (a, b) {</span> <span class="cstat-no" title="statement not covered" >return a &amp; b; </span>});</span>
}
exports.bitWiseAnd = bitWiseAnd;
<span class="fstat-no" title="function not covered" >function escape(s) {</span>
<span class="cstat-no" title="statement not covered" >    return _global.encodeURI(s);</span>
}
