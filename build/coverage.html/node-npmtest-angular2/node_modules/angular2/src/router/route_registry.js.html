...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-angular2/node_modules/angular2/src/router/route_registry.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-angular2/node_modules/angular2/src/router/route_registry.js</span></h1>
    <h2>
        
        Statements: <span class="metric">5.47% <small>(15 / 274)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">4.79% <small>(9 / 188)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-angular2/node_modules/angular2/src/router/</a> &#187; route_registry.js</div>
</div>
<div class="body">
...
465
466
467</td><td class="line-coverage"><span class="cline-any cline-yes">2</span>
...
<span class="cstat-no" title="statement not covered" >var route_config_impl_1 = require('./route_config/route_config_impl');</span>
<span class="cstat-no" title="statement not covered" >var rules_1 = require('./rules/rules');</span>
<span class="cstat-no" title="statement not covered" >var rule_set_1 = require('./rules/rule_set');</span>
<span class="cstat-no" title="statement not covered" >var instruction_1 = require('./instruction');</span>
<span class="cstat-no" title="statement not covered" >var route_config_normalizer_1 = require('./route_config/route_config_normalizer');</span>
<span class="cstat-no" title="statement not covered" >var url_parser_1 = require('./url_parser');</span>
...
<span class="cstat-no" title="statement not covered" >                    routeCfgs.forEach(<span class="fstat-no" title="function not covered" >function (config) {</span> <span class="cstat-no" title="statement not covered" >return _this.config(component, config); </span>});</span>
                }
            }
        }
    };
...
<span class="cstat-no" title="statement not covered" >        var _this = this;</span>
<span class="cstat-no" title="statement not covered" >        if (_aux === void 0) { <span class="cstat-no" title="statement not covered" >_aux = false; </span>}</span>
...
<span class="cstat-no" title="statement not covered" >        var parentComponent = lang_1.isPresent(parentInstruction) ? parentInstruction.component.componentType :</span>
            this._rootComponent;
<span class="cstat-no" title="statement not covered" >        var rules = this._rules.get(parentComponent);</span>
<span class="cstat-no" title="statement not covered" >        if (lang_1.isBlank(rules)) {</span>
...
<span class="cstat-no" title="statement not covered" >        var matchPromises = possibleMatches.map(<span class="fstat-no" title="function not covered" >function (candidate) {</span> <span class="cstat-no" title="statement not covered" >return candidate.then(<span class="fstat-no" title="function not covered" >function (candidate) {</span></span></span>
...
<span class="cstat-no" title="statement not covered" >                return _this._recognize(candidate.remaining, newAncestorInstructions)</span>
                    .then(<span class="fstat-no" title="function not covered" >function (childInstruction) {</span>
...
<span class="cstat-no" title="statement not covered" >            unresolvedAuxInstructions[auxUrl.path] = new instruction_1.UnresolvedInstruction(<span class="fstat-no" title="function not covered" >function () {</span> <span class="cstat-no" title="statement not covered" >return _this._recognize(auxUrl, parentInstructions, true); </span>});</span>
        });
...
<span class="cstat-no" title="statement not covered" >                var parentRouteExists = lang_1.isPresent(grandparentComponentType) &amp;&amp;</span>
...
<span class="cstat-no" title="statement not covered" >            componentInstruction = _aux ? rules.generateAuxiliary(routeName, routeParams) :</span>
...
<span class="cstat-no" title="statement not covered" >        return new instruction_1.UnresolvedInstruction(<span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >            return rules.defaultRule.handler.resolveComponentType().then(<span class="fstat-no" title="function not covered" >function (_) {</span> <span class="cstat-no" title="statement not covered" >return _this.generateDefault(componentCursor); </span>});</span>
        });
    };
<span class="cstat-no" title="statement not covered" >    RouteRegistry = __decorate([</span>
        core_1.Injectable(),
...
<span class="cstat-no" title="statement not covered" >    instructions = instructions.filter(<span class="fstat-no" title="function not covered" >function (instruction) {</span> <span class="cstat-no" title="statement not covered" >return lang_1.isPresent(instruction); </span>});</span>
