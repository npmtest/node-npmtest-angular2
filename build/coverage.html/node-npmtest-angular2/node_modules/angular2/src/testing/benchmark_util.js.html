...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-angular2/node_modules/angular2/src/testing/benchmark_util.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-angular2/node_modules/angular2/src/testing/benchmark_util.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-angular2/node_modules/angular2/src/testing/</a> &#187; benchmark_util.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >var DOM = new browser_adapter_1.BrowserDomAdapter();</span>
<span class="fstat-no" title="function not covered" >function getIntParameter(name) {</span>
<span class="cstat-no" title="statement not covered" >    return lang_1.NumberWrapper.parseInt(getStringParameter(name), 10);</span>
}
<span class="cstat-no" title="statement not covered" >exports.getIntParameter = getIntParameter;</span>
<span class="fstat-no" title="function not covered" >function getStringParameter(name) {</span>
<span class="cstat-no" title="statement not covered" >    var els = DOM.querySelectorAll(browser_1.document, "input[name=\"" + name + "\"]");</span>
...
<span class="cstat-no" title="statement not covered" >        var type = DOM.type(el);</span>
<span class="cstat-no" title="statement not covered" >        if ((type != 'radio' &amp;&amp; type != 'checkbox') || DOM.getChecked(el)) {</span>
<span class="cstat-no" title="statement not covered" >            value = DOM.getValue(el);</span>
<span class="cstat-no" title="statement not covered" >            break;</span>
        }
    }
<span class="cstat-no" title="statement not covered" >    if (lang_1.isBlank(value)) {</span>
<span class="cstat-no" title="statement not covered" >        throw new exceptions_1.BaseException("Could not find and input field with name " + name);</span>
    }
<span class="cstat-no" title="statement not covered" >    return value;</span>
}
<span class="cstat-no" title="statement not covered" >exports.getStringParameter = getStringParameter;</span>
<span class="fstat-no" title="function not covered" >function bindAction(selector, callback) {</span>
<span class="cstat-no" title="statement not covered" >    var el = DOM.querySelector(browser_1.document, selector);</span>
<span class="cstat-no" title="statement not covered" >    DOM.on(el, 'click', <span class="fstat-no" title="function not covered" >function (_) {</span> <span class="cstat-no" title="statement not covered" >callback(); </span>});</span>
}
<span class="cstat-no" title="statement not covered" >exports.bindAction = bindAction;</span>
<span class="fstat-no" title="function not covered" >function microBenchmark(name, iterationCount, callback) {</span>
<span class="cstat-no" title="statement not covered" >    var durationName = name + "/" + iterationCount;</span>
<span class="cstat-no" title="statement not covered" >    browser_1.window.console.time(durationName);</span>
<span class="cstat-no" title="statement not covered" >    callback();</span>
<span class="cstat-no" title="statement not covered" >    browser_1.window.console.timeEnd(durationName);</span>
}
<span class="cstat-no" title="statement not covered" >exports.microBenchmark = microBenchmark;</span>
<span class="fstat-no" title="function not covered" >function windowProfile(name) {</span>
<span class="cstat-no" title="statement not covered" >    browser_1.window.console.profile(name);</span>
}
<span class="cstat-no" title="statement not covered" >exports.windowProfile = windowProfile;</span>
<span class="fstat-no" title="function not covered" >function windowProfileEnd(name) {</span>
<span class="cstat-no" title="statement not covered" >    browser_1.window.console.profileEnd(name);</span>
}
<span class="cstat-no" title="statement not covered" >exports.windowProfileEnd = windowProfileEnd;</span>
