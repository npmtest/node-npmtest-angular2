...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-angular2/node_modules/angular2/src/alt_router/router.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-angular2/node_modules/angular2/src/alt_router/router.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-angular2/node_modules/angular2/src/alt_router/</a> &#187; router.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >var recognize_1 = require('./recognize');</span>
<span class="cstat-no" title="statement not covered" >var segments_1 = require('./segments');</span>
<span class="cstat-no" title="statement not covered" >var lifecycle_reflector_1 = require('./lifecycle_reflector');</span>
<span class="cstat-no" title="statement not covered" >var RouterOutletMap = (<span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="fstat-no" title="function not covered" >    function RouterOutletMap() {</span>
        /** @internal */
<span class="cstat-no" title="statement not covered" >        this._outlets = {};</span>
    }
<span class="cstat-no" title="statement not covered" >    RouterOutletMap.prototype.registerOutlet = <span class="fstat-no" title="function not covered" >function (name, outlet) {</span> <span class="cstat-no" title="statement not covered" >this._outlets[name] = outlet; </span>};</span>
<span class="cstat-no" title="statement not covered" >    return RouterOutletMap;</span>
}());
<span class="cstat-no" title="statement not covered" >exports.RouterOutletMap = RouterOutletMap;</span>
...
<span class="fstat-no" title="function not covered" >    function Router(_componentType, _componentResolver, _urlParser, _routerOutletMap) {</span>
<span class="cstat-no" title="statement not covered" >        this._componentType = _componentType;</span>
<span class="cstat-no" title="statement not covered" >        this._componentResolver = _componentResolver;</span>
<span class="cstat-no" title="statement not covered" >        this._urlParser = _urlParser;</span>
<span class="cstat-no" title="statement not covered" >        this._routerOutletMap = _routerOutletMap;</span>
    }
<span class="cstat-no" title="statement not covered" >    Router.prototype.navigateByUrl = <span class="fstat-no" title="function not covered" >function (url) {</span></span>
<span class="cstat-no" title="statement not covered" >        var _this = this;</span>
<span class="cstat-no" title="statement not covered" >        var urlSegmentTree = this._urlParser.parse(url.substring(1));</span>
<span class="cstat-no" title="statement not covered" >        return recognize_1.recognize(this._componentResolver, this._componentType, urlSegmentTree)</span>
            .then(<span class="fstat-no" title="function not covered" >function (currTree) {</span>
<span class="cstat-no" title="statement not covered" >            var prevRoot = lang_1.isPresent(_this.prevTree) ? _this.prevTree.root : null;</span>
<span class="cstat-no" title="statement not covered" >            _loadSegments(currTree, currTree.root, _this.prevTree, prevRoot, _this, _this._routerOutletMap);</span>
<span class="cstat-no" title="statement not covered" >            _this.prevTree = currTree;</span>
        });
    };
...
<span class="fstat-no" title="function not covered" >function _loadSegments(currTree, curr, prevTree, prev, router, parentOutletMap) {</span>
<span class="cstat-no" title="statement not covered" >    var outlet = parentOutletMap._outlets[curr.outlet];</span>
<span class="cstat-no" title="statement not covered" >    var outletMap;</span>
<span class="cstat-no" title="statement not covered" >    if (segments_1.equalSegments(curr, prev)) {</span>
<span class="cstat-no" title="statement not covered" >        outletMap = outlet.outletMap;</span>
    }
    else {
<span class="cstat-no" title="statement not covered" >        outletMap = new RouterOutletMap();</span>
<span class="cstat-no" title="statement not covered" >        var resolved = core_1.ReflectiveInjector.resolve([core_1.provide(RouterOutletMap, { useValue: outletMap }), core_1.provide(segments_1.RouteSegment, { useValue: curr })]);</span>
<span class="cstat-no" title="statement not covered" >        var ref = outlet.load(segments_1.routeSegmentComponentFactory(curr), resolved, outletMap);</span>
<span class="cstat-no" title="statement not covered" >        if (lifecycle_reflector_1.hasLifecycleHook("routerOnActivate", ref.instance)) {</span>
<span class="cstat-no" title="statement not covered" >            ref.instance.routerOnActivate(curr, prev, currTree, prevTree);</span>
        }
    }
<span class="cstat-no" title="statement not covered" >    if (lang_1.isPresent(currTree.firstChild(curr))) {</span>
<span class="cstat-no" title="statement not covered" >        var cc = currTree.firstChild(curr);</span>
<span class="cstat-no" title="statement not covered" >        var pc = lang_1.isBlank(prevTree) ? null : prevTree.firstChild(prev);</span>
<span class="cstat-no" title="statement not covered" >        _loadSegments(currTree, cc, prevTree, pc, router, outletMap);</span>
    }
}
