...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-angular2/node_modules/angular2/src/core/application_common_providers.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-angular2/node_modules/angular2/src/core/application_common_providers.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-angular2/node_modules/angular2/src/core/</a> &#187; application_common_providers.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >var application_ref_1 = require('./application_ref');</span>
<span class="cstat-no" title="statement not covered" >var change_detection_1 = require('./change_detection/change_detection');</span>
<span class="cstat-no" title="statement not covered" >var view_utils_1 = require("./linker/view_utils");</span>
<span class="cstat-no" title="statement not covered" >var component_resolver_1 = require('./linker/component_resolver');</span>
...
<span class="cstat-no" title="statement not covered" >var __unused; </span>// avoid unused import when Type union types are erased
/**
 * A default set of providers which should be included in any Angular
 * application, regardless of the platform it runs onto.
 */
<span class="cstat-no" title="statement not covered" >exports.APPLICATION_COMMON_PROVIDERS = lang_1.CONST_EXPR([</span>
