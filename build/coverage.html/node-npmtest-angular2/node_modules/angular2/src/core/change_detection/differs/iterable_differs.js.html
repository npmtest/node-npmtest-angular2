...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-angular2/node_modules/angular2/src/core/change_detection/differs/iterable_differs.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-angular2/node_modules/angular2/src/core/change_detection/differs/iterable_differs.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-angular2/node_modules/angular2/src/core/change_detection/differs/</a> &#187; iterable_differs.js</div>
</div>
<div class="body">
...
81
82
83</td><td class="line-coverage"><span class="cline-any cline-yes">18</span>
 ...
 */
<span class="cstat-no" title="statement not covered" >var IterableDiffers = (<span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="fstat-no" title="function not covered" >    function IterableDiffers(factories) {</span>
<span class="cstat-no" title="statement not covered" >        this.factories = factories;</span>
    }
<span class="cstat-no" title="statement not covered" >    IterableDiffers.create = <span class="fstat-no" title="function not covered" >function (factories, parent) {</span></span>
<span class="cstat-no" title="statement not covered" >        if (lang_1.isPresent(parent)) {</span>
<span class="cstat-no" title="statement not covered" >            var copied = collection_1.ListWrapper.clone(parent.factories);</span>
<span class="cstat-no" title="statement not covered" >            factories = factories.concat(copied);</span>
<span class="cstat-no" title="statement not covered" >            return new IterableDiffers(factories);</span>
        }
        else {
<span class="cstat-no" title="statement not covered" >            return new IterableDiffers(factories);</span>
        }
     ...
     * ```
     */
<span class="cstat-no" title="statement not covered" >    IterableDiffers.extend = <span class="fstat-no" title="function not covered" >function (factories) {</span></span>
<span class="cstat-no" title="statement not covered" >        return new di_1.Provider(IterableDiffers, {</span>
            useFactory: <span class="fstat-no" title="function not covered" >function (parent) {</span>
<span class="cstat-no" title="statement not covered" >                if (lang_1.isBlank(parent)) {</span>
                    // Typically would occur when calling IterableDiffers.extend inside of dependencies passed
                    // to
                    // bootstrap(), which would override default pipes instead of extending them.
<span class="cstat-no" title="statement not covered" >                    throw new exceptions_1.BaseException('Cannot extend IterableDiffers without a parent injector');</span>
                }
<span class="cstat-no" title="statement not covered" >                return IterableDiffers.create(factories, parent);</span>
            },
            // Dependency technically isn't optional, but we can provide a better error message this way.
            deps: [[IterableDiffers, new di_1.SkipSelfMetadata(), new di_1.OptionalMetadata()]]
        });
    };
<span class="cstat-no" title="statement not covered" >    IterableDiffers.prototype.find = <span class="fstat-no" title="function not covered" >function (iterable) {</span></span>
<span class="cstat-no" title="statement not covered" >        var factory = this.factories.find(<span class="fstat-no" title="function not covered" >function (f) {</span> <span class="cstat-no" title="statement not covered" >return f.supports(iterable); </span>});</span>
<span class="cstat-no" title="statement not covered" >        if (lang_1.isPresent(factory)) {</span>
<span class="cstat-no" title="statement not covered" >            return factory;</span>
        }
        else {
<span class="cstat-no" title="statement not covered" >            throw new exceptions_1.BaseException("Cannot find a differ supporting object '" + iterable + "' of type '" + lang_1.getTypeNameForDebugging(iterable) + "'");</span>
        }
    };
<span class="cstat-no" title="statement not covered" >    IterableDiffers = __decorate([</span>
        lang_1.CONST(), 
        __metadata('design:paramtypes', [Array])
    ], IterableDiffers);
<span class="cstat-no" title="statement not covered" >    return IterableDiffers;</span>
}());
<span class="cstat-no" title="statement not covered" >exports.IterableDiffers = IterableDiffers;</span>
