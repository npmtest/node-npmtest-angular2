...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-angular2/node_modules/angular2/platform/browser_static.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-angular2/node_modules/angular2/platform/browser_static.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-angular2/node_modules/angular2/platform/</a> &#187; browser_static.js</div>
</div>
<div class="body">
 ...
 */
<span class="cstat-no" title="statement not covered" >exports.BROWSER_APP_PROVIDERS = browser_common_2.BROWSER_APP_COMMON_PROVIDERS;</span>
<span class="fstat-no" title="function not covered" >function browserStaticPlatform() {</span>
...
<span class="cstat-no" title="statement not covered" >exports.browserStaticPlatform = browserStaticPlatform;</span>
/**
 * See {@link bootstrap} for more information.
 */
<span class="fstat-no" title="function not covered" >function bootstrapStatic(appComponentType, customProviders, initReflector) {</span>
<span class="cstat-no" title="statement not covered" >    if (lang_1.isPresent(initReflector)) {</span>
<span class="cstat-no" title="statement not covered" >        initReflector();</span>
    }
<span class="cstat-no" title="statement not covered" >    var appProviders = lang_1.isPresent(customProviders) ? [exports.BROWSER_APP_PROVIDERS, customProviders] : exports.BROWSER_APP_PROVIDERS;</span>
<span class="cstat-no" title="statement not covered" >    var appInjector = core_1.ReflectiveInjector.resolveAndCreate(appProviders, browserStaticPlatform().injector);</span>
<span class="cstat-no" title="statement not covered" >    return core_1.coreLoadAndBootstrap(appInjector, appComponentType);</span>
}
<span class="cstat-no" title="statement not covered" >exports.bootstrapStatic = bootstrapStatic;</span>
