...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-angular2/node_modules/angular2/src/common/directives/ng_class.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-angular2/node_modules/angular2/src/common/directives/ng_class.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-angular2/node_modules/angular2/src/common/directives/</a> &#187; ng_class.js</div>
</div>
<div class="body">
 ...
 * ```
 */
<span class="cstat-no" title="statement not covered" >var NgClass = (<span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="fstat-no" title="function not covered" >    function NgClass(_iterableDiffers, _keyValueDiffers, _ngEl, _renderer) {</span>
<span class="cstat-no" title="statement not covered" >        this._iterableDiffers = _iterableDiffers;</span>
<span class="cstat-no" title="statement not covered" >        this._keyValueDiffers = _keyValueDiffers;</span>
...
<span class="cstat-no" title="statement not covered" >        this._initialClasses = [];</span>
    }
<span class="cstat-no" title="statement not covered" >    Object.defineProperty(NgClass.prototype, "initialClasses", {</span>
        set: <span class="fstat-no" title="function not covered" >function (v) {</span>
<span class="cstat-no" title="statement not covered" >            this._applyInitialClasses(true);</span>
<span class="cstat-no" title="statement not covered" >            this._initialClasses = lang_1.isPresent(v) &amp;&amp; lang_1.isString(v) ? v.split(' ') : [];</span>
<span class="cstat-no" title="statement not covered" >            this._applyInitialClasses(false);</span>
<span class="cstat-no" title="statement not covered" >            this._applyClasses(this._rawClass, false);</span>
        },
        enumerable: true,
        configurable: true
    });
<span class="cstat-no" title="statement not covered" >    Object.defineProperty(NgClass.prototype, "rawClass", {</span>
        set: <span class="fstat-no" title="function not covered" >function (v) {</span>
<span class="cstat-no" title="statement not covered" >            this._cleanupClasses(this._rawClass);</span>
<span class="cstat-no" title="statement not covered" >            if (lang_1.isString(v)) {</span>
<span class="cstat-no" title="statement not covered" >                v = v.split(' ');</span>
            }
<span class="cstat-no" title="statement not covered" >            this._rawClass = v;</span>
<span class="cstat-no" title="statement not covered" >            this._iterableDiffer = null;</span>
<span class="cstat-no" title="statement not covered" >            this._keyValueDiffer = null;</span>
<span class="cstat-no" title="statement not covered" >            if (lang_1.isPresent(v)) {</span>
<span class="cstat-no" title="statement not covered" >                if (collection_1.isListLikeIterable(v)) {</span>
<span class="cstat-no" title="statement not covered" >                    this._iterableDiffer = this._iterableDiffers.find(v).create(null);</span>
                }
                else {
<span class="cstat-no" title="statement not covered" >                    this._keyValueDiffer = this._keyValueDiffers.find(v).create(null);</span>
                }
            }
        },
        enumerable: true,
...
<span class="cstat-no" title="statement not covered" >    NgClass.prototype.ngDoCheck = <span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >        if (lang_1.isPresent(this._iterableDiffer)) {</span>
<span class="cstat-no" title="statement not covered" >            var changes = this._iterableDiffer.diff(this._rawClass);</span>
<span class="cstat-no" title="statement not covered" >            if (lang_1.isPresent(changes)) {</span>
<span class="cstat-no" title="statement not covered" >                this._applyIterableChanges(changes);</span>
            }
        }
<span class="cstat-no" title="statement not covered" >        if (lang_1.isPresent(this._keyValueDiffer)) {</span>
<span class="cstat-no" title="statement not covered" >            var changes = this._keyValueDiffer.diff(this._rawClass);</span>
<span class="cstat-no" title="statement not covered" >            if (lang_1.isPresent(changes)) {</span>
<span class="cstat-no" title="statement not covered" >                this._applyKeyValueChanges(changes);</span>
            }
        }
    };
<span class="cstat-no" title="statement not covered" >    NgClass.prototype.ngOnDestroy = <span class="fstat-no" title="function not covered" >function () {</span> <span class="cstat-no" title="statement not covered" >this._cleanupClasses(this._rawClass); </span>};</span>
<span class="cstat-no" title="statement not covered" >    NgClass.prototype._cleanupClasses = <span class="fstat-no" title="function not covered" >function (rawClassVal) {</span></span>
<span class="cstat-no" title="statement not covered" >        this._applyClasses(rawClassVal, true);</span>
<span class="cstat-no" title="statement not covered" >        this._applyInitialClasses(false);</span>
    };
<span class="cstat-no" title="statement not covered" >    NgClass.prototype._applyKeyValueChanges = <span class="fstat-no" title="function not covered" >function (changes) {</span></span>
<span class="cstat-no" title="statement not covered" >        var _this = this;</span>
<span class="cstat-no" title="statement not covered" >        changes.forEachAddedItem(<span class="fstat-no" title="function not covered" >function (record) {</span> <span class="cstat-no" title="statement not covered" >_this._toggleClass(record.key, record.currentValue); </span>});</span>
<span class="cstat-no" title="statement not covered" >        changes.forEachChangedItem(<span class="fstat-no" title="function not covered" >function (record) {</span> <span class="cstat-no" title="statement not covered" >_this._toggleClass(record.key, record.currentValue); </span>});</span>
<span class="cstat-no" title="statement not covered" >        changes.forEachRemovedItem(<span class="fstat-no" title="function not covered" >function (record) {</span></span>
<span class="cstat-no" title="statement not covered" >            if (record.previousValue) {</span>
<span class="cstat-no" title="statement not covered" >                _this._toggleClass(record.key, false);</span>
            }
        });
    };
<span class="cstat-no" title="statement not covered" >    NgClass.prototype._applyIterableChanges = <span class="fstat-no" title="function not covered" >function (changes) {</span></span>
<span class="cstat-no" title="statement not covered" >        var _this = this;</span>
<span class="cstat-no" title="statement not covered" >        changes.forEachAddedItem(<span class="fstat-no" title="function not covered" >function (record) {</span> <span class="cstat-no" title="statement not covered" >_this._toggleClass(record.item, true); </span>});</span>
<span class="cstat-no" title="statement not covered" >        changes.forEachRemovedItem(<span class="fstat-no" title="function not covered" >function (record) {</span> <span class="cstat-no" title="statement not covered" >_this._toggleClass(record.item, false); </span>});</span>
    };
<span class="cstat-no" title="statement not covered" >    NgClass.prototype._applyInitialClasses = <span class="fstat-no" title="function not covered" >function (isCleanup) {</span></span>
<span class="cstat-no" title="statement not covered" >        var _this = this;</span>
<span class="cstat-no" title="statement not covered" >        this._initialClasses.forEach(<span class="fstat-no" title="function not covered" >function (className) {</span> <span class="cstat-no" title="statement not covered" >return _this._toggleClass(className, !isCleanup); </span>});</span>
    };
<span class="cstat-no" title="statement not covered" >    NgClass.prototype._applyClasses = <span class="fstat-no" title="function not covered" >function (rawClassVal, isCleanup) {</span></span>
<span class="cstat-no" title="statement not covered" >        var _this = this;</span>
<span class="cstat-no" title="statement not covered" >        if (lang_1.isPresent(rawClassVal)) {</span>
<span class="cstat-no" title="statement not covered" >            if (lang_1.isArray(rawClassVal)) {</span>
<span class="cstat-no" title="statement not covered" >                rawClassVal.forEach(<span class="fstat-no" title="function not covered" >function (className) {</span> <span class="cstat-no" title="statement not covered" >return _this._toggleClass(className, !isCleanup); </span>});</span>
            }
            else <span class="cstat-no" title="statement not covered" >if (rawClassVal instanceof Set) {</span>
<span class="cstat-no" title="statement not covered" >                rawClassVal.forEach(<span class="fstat-no" title="function not covered" >function (className) {</span> <span class="cstat-no" title="statement not covered" >return _this._toggleClass(className, !isCleanup); </span>});</span>
            }
            else {
<span class="cstat-no" title="statement not covered" >                collection_1.StringMapWrapper.forEach(rawClassVal, <span class="fstat-no" title="function not covered" >function (expVal, className) {</span></span>
<span class="cstat-no" title="statement not covered" >                    if (lang_1.isPresent(expVal))</span>
<span class="cstat-no" title="statement not covered" >                        _this._toggleClass(className, !isCleanup);</span>
                });
            }
        }
    };
<span class="cstat-no" title="statement not covered" >    NgClass.prototype._toggleClass = <span class="fstat-no" title="function not covered" >function (className, enabled) {</span></span>
<span class="cstat-no" title="statement not covered" >        className = className.trim();</span>
<span class="cstat-no" title="statement not covered" >        if (className.length &gt; 0) {</span>
<span class="cstat-no" title="statement not covered" >            if (className.indexOf(' ') &gt; -1) {</span>
<span class="cstat-no" title="statement not covered" >                var classes = className.split(/\s+/g);</span>
<span class="cstat-no" title="statement not covered" >                for (var i = 0, len = classes.length; i &lt; len; i++) {</span>
<span class="cstat-no" title="statement not covered" >                    this._renderer.setElementClass(this._ngEl.nativeElement, classes[i], enabled);</span>
                }
            }
            else {
<span class="cstat-no" title="statement not covered" >                this._renderer.setElementClass(this._ngEl.nativeElement, className, enabled);</span>
            }
        }
    };
<span class="cstat-no" title="statement not covered" >    NgClass = __decorate([</span>
...
<span class="cstat-no" title="statement not covered" >    return NgClass;</span>
}());
<span class="cstat-no" title="statement not covered" >exports.NgClass = NgClass;</span>
