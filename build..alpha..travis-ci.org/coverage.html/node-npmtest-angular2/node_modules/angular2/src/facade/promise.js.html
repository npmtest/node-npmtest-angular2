...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-angular2/node_modules/angular2/src/facade/promise.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-angular2/node_modules/angular2/src/facade/promise.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-angular2/node_modules/angular2/src/facade/</a> &#187; promise.js</div>
</div>
<div class="body">
...
<span class="fstat-no" title="function not covered" >    function PromiseCompleter() {</span>
<span class="cstat-no" title="statement not covered" >        var _this = this;</span>
<span class="cstat-no" title="statement not covered" >        this.promise = new Promise(<span class="fstat-no" title="function not covered" >function (res, rej) {</span></span>
<span class="cstat-no" title="statement not covered" >            _this.resolve = res;</span>
<span class="cstat-no" title="statement not covered" >            _this.reject = rej;</span>
        });
    }
...
<span class="fstat-no" title="function not covered" >    function PromiseWrapper() {</span>
    }
    PromiseWrapper.resolve = <span class="fstat-no" title="function not covered" >function (obj) {</span> <span class="cstat-no" title="statement not covered" >return Promise.resolve(obj); </span>};
    PromiseWrapper.reject = <span class="fstat-no" title="function not covered" >function (obj, _) {</span> <span class="cstat-no" title="statement not covered" >return Promise.reject(obj); </span>};
    // Note: We can't rename this method into `catch`, as this is not a valid
    // method name in Dart.
    PromiseWrapper.catchError = <span class="fstat-no" title="function not covered" >function (promise, onError) {</span>
<span class="cstat-no" title="statement not covered" >        return promise.catch(onError);</span>
    };
    PromiseWrapper.all = <span class="fstat-no" title="function not covered" >function (promises) {</span>
...
<span class="cstat-no" title="statement not covered" >        return Promise.all(promises);</span>
    ...
    PromiseWrapper.then = <span class="fstat-no" title="function not covered" >function (promise, success, rejection) {</span>
<span class="cstat-no" title="statement not covered" >        return promise.then(success, rejection);</span>
    };
    PromiseWrapper.wrap = <span class="fstat-no" title="function not covered" >function (computation) {</span>
...
<span class="cstat-no" title="statement not covered" >                res(computation());</span>
            }
            catch (e) {
<span class="cstat-no" title="statement not covered" >                rej(e);</span>
    ...
    PromiseWrapper.scheduleMicrotask = <span class="fstat-no" title="function not covered" >function (computation) {</span>
<span class="cstat-no" title="statement not covered" >        PromiseWrapper.then(PromiseWrapper.resolve(null), computation, <span class="fstat-no" title="function not covered" >function (_) {</span> });</span>
    };
    PromiseWrapper.isPromise = <span class="fstat-no" title="function not covered" >function (obj) {</span> <span class="cstat-no" title="statement not covered" >return obj instanceof Promise; </span>};
    PromiseWrapper.completer = <span class="fstat-no" title="function not covered" >function () {</span> <span class="cstat-no" title="statement not covered" >return new PromiseCompleter(); </span>};
