...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-angular2/node_modules/angular2/src/facade/exceptions.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-angular2/node_modules/angular2/src/facade/exceptions.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-angular2/node_modules/angular2/src/facade/</a> &#187; exceptions.js</div>
</div>
<div class="body">
...
<span class="fstat-no" title="function not covered" >    function BaseException(message) {</span>
<span class="cstat-no" title="statement not covered" >        if (message === void 0) { <span class="cstat-no" title="statement not covered" >message = "--"; </span>}</span>
...
<span class="cstat-no" title="statement not covered" >        this.stack = (new Error(message)).stack;</span>
    ...
    BaseException.prototype.toString = <span class="fstat-no" title="function not covered" >function () {</span> <span class="cstat-no" title="statement not covered" >return this.message; </span>};
...
<span class="fstat-no" title="function not covered" >    function WrappedException(_wrapperMessage, _originalException, _originalStack, _context) {</span>
<span class="cstat-no" title="statement not covered" >        _super.call(this, _wrapperMessage);</span>
<span class="cstat-no" title="statement not covered" >        this._wrapperMessage = _wrapperMessage;</span>
<span class="cstat-no" title="statement not covered" >        this._originalException = _originalException;</span>
<span class="cstat-no" title="statement not covered" >        this._originalStack = _originalStack;</span>
<span class="cstat-no" title="statement not covered" >        this._context = _context;</span>
<span class="cstat-no" title="statement not covered" >        this._wrapperStack = (new Error(_wrapperMessage)).stack;</span>
    }
    Object.defineProperty(WrappedException.prototype, "wrapperMessage", {
        get: <span class="fstat-no" title="function not covered" >function () {</span> <span class="cstat-no" title="statement not covered" >return this._wrapperMessage; </span>},
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(WrappedException.prototype, "wrapperStack", {
        get: <span class="fstat-no" title="function not covered" >function () {</span> <span class="cstat-no" title="statement not covered" >return this._wrapperStack; </span>},
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(WrappedException.prototype, "originalException", {
        get: <span class="fstat-no" title="function not covered" >function () {</span> <span class="cstat-no" title="statement not covered" >return this._originalException; </span>},
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(WrappedException.prototype, "originalStack", {
        get: <span class="fstat-no" title="function not covered" >function () {</span> <span class="cstat-no" title="statement not covered" >return this._originalStack; </span>},
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(WrappedException.prototype, "context", {
        get: <span class="fstat-no" title="function not covered" >function () {</span> <span class="cstat-no" title="statement not covered" >return this._context; </span>},
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(WrappedException.prototype, "message", {
        get: <span class="fstat-no" title="function not covered" >function () {</span> <span class="cstat-no" title="statement not covered" >return exception_handler_1.ExceptionHandler.exceptionToString(this); </span>},
        enumerable: true,
        configurable: true
    });
    WrappedException.prototype.toString = <span class="fstat-no" title="function not covered" >function () {</span> <span class="cstat-no" title="statement not covered" >return this.message; </span>};
    return WrappedException;
}(base_wrapped_exception_1.BaseWrappedException));
exports.WrappedException = WrappedException;
<span class="fstat-no" title="function not covered" >function makeTypeError(message) {</span>
<span class="cstat-no" title="statement not covered" >    return new TypeError(message);</span>
}
exports.makeTypeError = makeTypeError;
<span class="fstat-no" title="function not covered" >function unimplemented() {</span>
<span class="cstat-no" title="statement not covered" >    throw new BaseException('unimplemented');</span>
}
