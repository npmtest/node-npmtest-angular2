...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-angular2/node_modules/angular2/src/alt_router/recognize.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-angular2/node_modules/angular2/src/alt_router/recognize.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-angular2/node_modules/angular2/src/alt_router/</a> &#187; recognize.js</div>
</div>
<div class="body">
...
<span class="fstat-no" title="function not covered" >function recognize(componentResolver, type, url) {</span>
<span class="cstat-no" title="statement not covered" >    return _recognize(componentResolver, type, url, url.root)</span>
        .then(<span class="fstat-no" title="function not covered" >function (nodes) {</span> <span class="cstat-no" title="statement not covered" >return new segments_1.Tree(nodes); </span>});
}
exports.recognize = recognize;
<span class="fstat-no" title="function not covered" >function _recognize(componentResolver, type, url, current) {</span>
<span class="cstat-no" title="statement not covered" >    var metadata = _readMetadata(type); </span>// should read from the factory instead
<span class="cstat-no" title="statement not covered" >    var matched;</span>
<span class="cstat-no" title="statement not covered" >    try {</span>
<span class="cstat-no" title="statement not covered" >        matched = _match(metadata, url, current);</span>
    }
    catch (e) {
<span class="cstat-no" title="statement not covered" >        return promise_1.PromiseWrapper.reject(e, null);</span>
    }
<span class="cstat-no" title="statement not covered" >    return componentResolver.resolveComponent(matched.route.component)</span>
        .then(<span class="fstat-no" title="function not covered" >function (factory) {</span>
<span class="cstat-no" title="statement not covered" >        var segment = new segments_1.RouteSegment(matched.consumedUrlSegments, matched.parameters, "", matched.route.component, factory);</span>
<span class="cstat-no" title="statement not covered" >        if (lang_1.isPresent(matched.leftOver)) {</span>
<span class="cstat-no" title="statement not covered" >            return _recognize(componentResolver, matched.route.component, url, matched.leftOver)</span>
                .then(<span class="fstat-no" title="function not covered" >function (children) {</span> <span class="cstat-no" title="statement not covered" >return [segment].concat(children); </span>});
        }
        else {
...
<span class="fstat-no" title="function not covered" >function _match(metadata, url, current) {</span>
<span class="cstat-no" title="statement not covered" >    for (var _i = 0, _a = metadata.routes; _i &lt; _a.length; _i++) {</span>
<span class="cstat-no" title="statement not covered" >        var r = _a[_i];</span>
<span class="cstat-no" title="statement not covered" >        var matchingResult = _matchWithParts(r, url, current);</span>
<span class="cstat-no" title="statement not covered" >        if (lang_1.isPresent(matchingResult)) {</span>
<span class="cstat-no" title="statement not covered" >            return matchingResult;</span>
        }
    }
<span class="cstat-no" title="statement not covered" >    throw new exceptions_1.BaseException("Cannot match any routes");</span>
}
<span class="fstat-no" title="function not covered" >function _matchWithParts(route, url, current) {</span>
<span class="cstat-no" title="statement not covered" >    var parts = route.path.split("/");</span>
<span class="cstat-no" title="statement not covered" >    var parameters = {};</span>
<span class="cstat-no" title="statement not covered" >    var consumedUrlSegments = [];</span>
<span class="cstat-no" title="statement not covered" >    var u = current;</span>
<span class="cstat-no" title="statement not covered" >    for (var i = 0; i &lt; parts.length; ++i) {</span>
<span class="cstat-no" title="statement not covered" >        consumedUrlSegments.push(u);</span>
<span class="cstat-no" title="statement not covered" >        var p = parts[i];</span>
<span class="cstat-no" title="statement not covered" >        if (p.startsWith(":")) {</span>
<span class="cstat-no" title="statement not covered" >            var segment = u.segment;</span>
<span class="cstat-no" title="statement not covered" >            parameters[p.substring(1)] = segment;</span>
        }
        else <span class="cstat-no" title="statement not covered" >if (p != u.segment) {</span>
<span class="cstat-no" title="statement not covered" >            return null;</span>
        }
<span class="cstat-no" title="statement not covered" >        u = url.firstChild(u);</span>
    }
<span class="cstat-no" title="statement not covered" >    return new _MatchingResult(route, consumedUrlSegments, parameters, u);</span>
}
var _MatchingResult = (function () {
<span class="fstat-no" title="function not covered" >    function _MatchingResult(route, consumedUrlSegments, parameters, leftOver) {</span>
<span class="cstat-no" title="statement not covered" >        this.route = route;</span>
<span class="cstat-no" title="statement not covered" >        this.consumedUrlSegments = consumedUrlSegments;</span>
<span class="cstat-no" title="statement not covered" >        this.parameters = parameters;</span>
<span class="cstat-no" title="statement not covered" >        this.leftOver = leftOver;</span>
    }
    return _MatchingResult;
}());
<span class="fstat-no" title="function not covered" >function _readMetadata(componentType) {</span>
<span class="cstat-no" title="statement not covered" >    var metadata = reflection_1.reflector.annotations(componentType).filter(<span class="fstat-no" title="function not covered" >function (f) {</span> <span class="cstat-no" title="statement not covered" >return f instanceof metadata_1.RoutesMetadata; </span>});</span>
<span class="cstat-no" title="statement not covered" >    if (metadata.length === 0) {</span>
<span class="cstat-no" title="statement not covered" >        throw new exceptions_1.BaseException("Component '" + lang_1.stringify(componentType) + "' does not have route configuration");</span>
    }
<span class="cstat-no" title="statement not covered" >    return metadata[0];</span>
}
