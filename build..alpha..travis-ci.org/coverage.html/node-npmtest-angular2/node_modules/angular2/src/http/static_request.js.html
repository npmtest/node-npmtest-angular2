...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-angular2/node_modules/angular2/src/http/static_request.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-angular2/node_modules/angular2/src/http/static_request.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-angular2/node_modules/angular2/src/http/</a> &#187; static_request.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >        this.headers = new headers_1.Headers(requestOptions.headers);</span>
     ...
     * string.
     */
    Request.prototype.text = <span class="fstat-no" title="function not covered" >function () {</span> <span class="cstat-no" title="statement not covered" >return lang_1.isPresent(this._body) ? this._body.toString() : ''; </span>};
    return Request;
}());
