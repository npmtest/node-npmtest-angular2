...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-angular2/node_modules/angular2/src/compiler/runtime_metadata.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-angular2/node_modules/angular2/src/compiler/runtime_metadata.js</span></h1>
    <h2>
        
        Statements: <span class="metric">5.14% <small>(11 / 214)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">8.18% <small>(9 / 110)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">0% <small>(0 / 34)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">5.39% <small>(11 / 204)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-angular2/node_modules/angular2/src/compiler/</a> &#187; runtime_metadata.js</div>
</div>
<div class="body">
...
352
353
354</td><td class="line-coverage"><span class="cline-any cline-yes">2</span>
...
<span class="cstat-no" title="statement not covered" >var reflective_exceptions_1 = require('angular2/src/core/di/reflective_exceptions');</span>
<span class="cstat-no" title="statement not covered" >var cpl = require('./compile_metadata');</span>
<span class="cstat-no" title="statement not covered" >var md = require('angular2/src/core/metadata/directives');</span>
<span class="cstat-no" title="statement not covered" >var dimd = require('angular2/src/core/metadata/di');</span>
<span class="cstat-no" title="statement not covered" >var directive_resolver_1 = require('./directive_resolver');</span>
<span class="cstat-no" title="statement not covered" >var pipe_resolver_1 = require('./pipe_resolver');</span>
<span class="cstat-no" title="statement not covered" >var view_resolver_1 = require('./view_resolver');</span>
<span class="cstat-no" title="statement not covered" >var directive_lifecycle_reflector_1 = require('./directive_lifecycle_reflector');</span>
...
<span class="cstat-no" title="statement not covered" >var platform_directives_and_pipes_1 = require('angular2/src/core/platform_directives_and_pipes');</span>
<span class="cstat-no" title="statement not covered" >var util_1 = require('./util');</span>
<span class="cstat-no" title="statement not covered" >var assertions_1 = require('./assertions');</span>
<span class="cstat-no" title="statement not covered" >var url_resolver_1 = require('angular2/src/compiler/url_resolver');</span>
<span class="cstat-no" title="statement not covered" >var provider_1 = require('angular2/src/core/di/provider');</span>
<span class="cstat-no" title="statement not covered" >var reflective_provider_1 = require('angular2/src/core/di/reflective_provider');</span>
<span class="cstat-no" title="statement not covered" >var metadata_1 = require('angular2/src/core/di/metadata');</span>
<span class="cstat-no" title="statement not covered" >var reflector_reader_1 = require('angular2/src/core/reflection/reflector_reader');</span>
<span class="cstat-no" title="statement not covered" >var RuntimeMetadataResolver = (<span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="fstat-no" title="function not covered" >    function RuntimeMetadataResolver(_directiveResolver, _pipeResolver, _viewResolver, _platformDirectives, _platformPipes, _reflector) {</span>
<span class="cstat-no" title="statement not covered" >        this._directiveResolver = _directiveResolver;</span>
<span class="cstat-no" title="statement not covered" >        this._pipeResolver = _pipeResolver;</span>
<span class="cstat-no" title="statement not covered" >        this._viewResolver = _viewResolver;</span>
<span class="cstat-no" title="statement not covered" >        this._platformDirectives = _platformDirectives;</span>
<span class="cstat-no" title="statement not covered" >        this._platformPipes = _platformPipes;</span>
<span class="cstat-no" title="statement not covered" >        this._directiveCache = new Map();</span>
<span class="cstat-no" title="statement not covered" >        this._pipeCache = new Map();</span>
<span class="cstat-no" title="statement not covered" >        this._anonymousTypes = new Map();</span>
<span class="cstat-no" title="statement not covered" >        this._anonymousTypeIndex = 0;</span>
<span class="cstat-no" title="statement not covered" >        if (lang_1.isPresent(_reflector)) {</span>
<span class="cstat-no" title="statement not covered" >            this._reflector = _reflector;</span>
        }
        else {
<span class="cstat-no" title="statement not covered" >            this._reflector = reflection_1.reflector;</span>
        }
    }
<span class="cstat-no" title="statement not covered" >    RuntimeMetadataResolver.prototype.sanitizeTokenName = <span class="fstat-no" title="function not covered" >function (token) {</span></span>
<span class="cstat-no" title="statement not covered" >        var identifier = lang_1.stringify(token);</span>
<span class="cstat-no" title="statement not covered" >        if (identifier.indexOf('(') &gt;= 0) {</span>
            // case: anonymous functions!
<span class="cstat-no" title="statement not covered" >            var found = this._anonymousTypes.get(token);</span>
<span class="cstat-no" title="statement not covered" >            if (lang_1.isBlank(found)) {</span>
<span class="cstat-no" title="statement not covered" >                this._anonymousTypes.set(token, this._anonymousTypeIndex++);</span>
<span class="cstat-no" title="statement not covered" >                found = this._anonymousTypes.get(token);</span>
            }
<span class="cstat-no" title="statement not covered" >            identifier = "anonymous_token_" + found + "_";</span>
        }
<span class="cstat-no" title="statement not covered" >        return util_1.sanitizeIdentifier(identifier);</span>
    };
<span class="cstat-no" title="statement not covered" >    RuntimeMetadataResolver.prototype.getDirectiveMetadata = <span class="fstat-no" title="function not covered" >function (directiveType) {</span></span>
<span class="cstat-no" title="statement not covered" >        var meta = this._directiveCache.get(directiveType);</span>
<span class="cstat-no" title="statement not covered" >        if (lang_1.isBlank(meta)) {</span>
<span class="cstat-no" title="statement not covered" >            var dirMeta = this._directiveResolver.resolve(directiveType);</span>
<span class="cstat-no" title="statement not covered" >            var moduleUrl = null;</span>
<span class="cstat-no" title="statement not covered" >            var templateMeta = null;</span>
<span class="cstat-no" title="statement not covered" >            var changeDetectionStrategy = null;</span>
<span class="cstat-no" title="statement not covered" >            var viewProviders = [];</span>
<span class="cstat-no" title="statement not covered" >            if (dirMeta instanceof md.ComponentMetadata) {</span>
<span class="cstat-no" title="statement not covered" >                assertions_1.assertArrayOfStrings('styles', dirMeta.styles);</span>
<span class="cstat-no" title="statement not covered" >                var cmpMeta = dirMeta;</span>
<span class="cstat-no" title="statement not covered" >                moduleUrl = calcModuleUrl(this._reflector, directiveType, cmpMeta);</span>
<span class="cstat-no" title="statement not covered" >                var viewMeta = this._viewResolver.resolve(directiveType);</span>
<span class="cstat-no" title="statement not covered" >                assertions_1.assertArrayOfStrings('styles', viewMeta.styles);</span>
<span class="cstat-no" title="statement not covered" >                templateMeta = new cpl.CompileTemplateMetadata({</span>
...
<span class="cstat-no" title="statement not covered" >                changeDetectionStrategy = cmpMeta.changeDetection;</span>
<span class="cstat-no" title="statement not covered" >                if (lang_1.isPresent(dirMeta.viewProviders)) {</span>
<span class="cstat-no" title="statement not covered" >                    viewProviders = this.getProvidersMetadata(dirMeta.viewProviders);</span>
                }
            }
<span class="cstat-no" title="statement not covered" >            var providers = [];</span>
<span class="cstat-no" title="statement not covered" >            if (lang_1.isPresent(dirMeta.providers)) {</span>
<span class="cstat-no" title="statement not covered" >                providers = this.getProvidersMetadata(dirMeta.providers);</span>
            }
<span class="cstat-no" title="statement not covered" >            var queries = [];</span>
<span class="cstat-no" title="statement not covered" >            var viewQueries = [];</span>
<span class="cstat-no" title="statement not covered" >            if (lang_1.isPresent(dirMeta.queries)) {</span>
<span class="cstat-no" title="statement not covered" >                queries = this.getQueriesMetadata(dirMeta.queries, false);</span>
<span class="cstat-no" title="statement not covered" >                viewQueries = this.getQueriesMetadata(dirMeta.queries, true);</span>
            }
<span class="cstat-no" title="statement not covered" >            meta = cpl.CompileDirectiveMetadata.create({</span>
                ...
                host: dirMeta.host,
                lifecycleHooks: lifecycle_hooks_1.LIFECYCLE_HOOKS_VALUES.filter(<span class="fstat-no" title="function not covered" >function (hook) {</span> <span class="cstat-no" title="statement not covered" >return directive_lifecycle_reflector_1.hasLifecycleHook(hook, directiveType); </span>}),
                providers: providers,
                viewProviders: viewProviders,
                queries: queries,
                viewQueries: viewQueries
            });
<span class="cstat-no" title="statement not covered" >            this._directiveCache.set(directiveType, meta);</span>
        }
<span class="cstat-no" title="statement not covered" >        return meta;</span>
    };
<span class="cstat-no" title="statement not covered" >    RuntimeMetadataResolver.prototype.getTypeMetadata = <span class="fstat-no" title="function not covered" >function (type, moduleUrl) {</span></span>
<span class="cstat-no" title="statement not covered" >        return new cpl.CompileTypeMetadata({</span>
...
<span class="cstat-no" title="statement not covered" >    RuntimeMetadataResolver.prototype.getFactoryMetadata = <span class="fstat-no" title="function not covered" >function (factory, moduleUrl) {</span></span>
<span class="cstat-no" title="statement not covered" >        return new cpl.CompileFactoryMetadata({</span>
...
<span class="cstat-no" title="statement not covered" >    RuntimeMetadataResolver.prototype.getPipeMetadata = <span class="fstat-no" title="function not covered" >function (pipeType) {</span></span>
<span class="cstat-no" title="statement not covered" >        var meta = this._pipeCache.get(pipeType);</span>
<span class="cstat-no" title="statement not covered" >        if (lang_1.isBlank(meta)) {</span>
<span class="cstat-no" title="statement not covered" >            var pipeMeta = this._pipeResolver.resolve(pipeType);</span>
<span class="cstat-no" title="statement not covered" >            var moduleUrl = this._reflector.importUri(pipeType);</span>
<span class="cstat-no" title="statement not covered" >            meta = new cpl.CompilePipeMetadata({</span>
                type: this.getTypeMetadata(pipeType, moduleUrl),
                name: pipeMeta.name,
                pure: pipeMeta.pure,
                lifecycleHooks: lifecycle_hooks_1.LIFECYCLE_HOOKS_VALUES.filter(<span class="fstat-no" title="function not covered" >function (hook) {</span> <span class="cstat-no" title="statement not covered" >return directive_lifecycle_reflector_1.hasLifecycleHook(hook, pipeType); </span>}),
            });
<span class="cstat-no" title="statement not covered" >            this._pipeCache.set(pipeType, meta);</span>
        }
<span class="cstat-no" title="statement not covered" >        return meta;</span>
    };
<span class="cstat-no" title="statement not covered" >    RuntimeMetadataResolver.prototype.getViewDirectivesMetadata = <span class="fstat-no" title="function not covered" >function (component) {</span></span>
<span class="cstat-no" title="statement not covered" >        var _this = this;</span>
<span class="cstat-no" title="statement not covered" >        var view = this._viewResolver.resolve(component);</span>
<span class="cstat-no" title="statement not covered" >        var directives = flattenDirectives(view, this._platformDirectives);</span>
<span class="cstat-no" title="statement not covered" >        for (var i = 0; i &lt; directives.length; i++) {</span>
<span class="cstat-no" title="statement not covered" >            if (!isValidType(directives[i])) {</span>
<span class="cstat-no" title="statement not covered" >                throw new exceptions_1.BaseException("Unexpected directive value '" + lang_1.stringify(directives[i]) + "' on the View of component '" + lang_1.stringify(component) + "'");</span>
            }
        }
<span class="cstat-no" title="statement not covered" >        return directives.map(<span class="fstat-no" title="function not covered" >function (type) {</span> <span class="cstat-no" title="statement not covered" >return _this.getDirectiveMetadata(type); </span>});</span>
    };
<span class="cstat-no" title="statement not covered" >    RuntimeMetadataResolver.prototype.getViewPipesMetadata = <span class="fstat-no" title="function not covered" >function (component) {</span></span>
<span class="cstat-no" title="statement not covered" >        var _this = this;</span>
<span class="cstat-no" title="statement not covered" >        var view = this._viewResolver.resolve(component);</span>
<span class="cstat-no" title="statement not covered" >        var pipes = flattenPipes(view, this._platformPipes);</span>
<span class="cstat-no" title="statement not covered" >        for (var i = 0; i &lt; pipes.length; i++) {</span>
<span class="cstat-no" title="statement not covered" >            if (!isValidType(pipes[i])) {</span>
<span class="cstat-no" title="statement not covered" >                throw new exceptions_1.BaseException("Unexpected piped value '" + lang_1.stringify(pipes[i]) + "' on the View of component '" + lang_1.stringify(component) + "'");</span>
            }
        }
<span class="cstat-no" title="statement not covered" >        return pipes.map(<span class="fstat-no" title="function not covered" >function (type) {</span> <span class="cstat-no" title="statement not covered" >return _this.getPipeMetadata(type); </span>});</span>
    };
<span class="cstat-no" title="statement not covered" >    RuntimeMetadataResolver.prototype.getDependenciesMetadata = <span class="fstat-no" title="function not covered" >function (typeOrFunc, dependencies) {</span></span>
<span class="cstat-no" title="statement not covered" >        var _this = this;</span>
<span class="cstat-no" title="statement not covered" >        var deps;</span>
<span class="cstat-no" title="statement not covered" >        try {</span>
<span class="cstat-no" title="statement not covered" >            deps = reflective_provider_1.constructDependencies(typeOrFunc, dependencies);</span>
        }
        catch (e) {
<span class="cstat-no" title="statement not covered" >            if (e instanceof reflective_exceptions_1.NoAnnotationError) {</span>
...
<span class="cstat-no" title="statement not covered" >        return deps.map(<span class="fstat-no" title="function not covered" >function (dep) {</span></span>
<span class="cstat-no" title="statement not covered" >            var compileToken;</span>
<span class="cstat-no" title="statement not covered" >            var p = dep.properties.find(<span class="fstat-no" title="function not covered" >function (p) {</span> <span class="cstat-no" title="statement not covered" >return p instanceof dimd.AttributeMetadata; </span>});</span>
<span class="cstat-no" title="statement not covered" >            var isAttribute = false;</span>
<span class="cstat-no" title="statement not covered" >            if (lang_1.isPresent(p)) {</span>
<span class="cstat-no" title="statement not covered" >                compileToken = _this.getTokenMetadata(p.attributeName);</span>
<span class="cstat-no" title="statement not covered" >                isAttribute = true;</span>
            }
            else {
<span class="cstat-no" title="statement not covered" >                compileToken = _this.getTokenMetadata(dep.key.token);</span>
            }
<span class="cstat-no" title="statement not covered" >            var compileQuery = null;</span>
<span class="cstat-no" title="statement not covered" >            var q = dep.properties.find(<span class="fstat-no" title="function not covered" >function (p) {</span> <span class="cstat-no" title="statement not covered" >return p instanceof dimd.QueryMetadata; </span>});</span>
<span class="cstat-no" title="statement not covered" >            if (lang_1.isPresent(q)) {</span>
<span class="cstat-no" title="statement not covered" >                compileQuery = _this.getQueryMetadata(q, null);</span>
            }
<span class="cstat-no" title="statement not covered" >            return new cpl.CompileDiDependencyMetadata({</span>
...
<span class="cstat-no" title="statement not covered" >    RuntimeMetadataResolver.prototype.getTokenMetadata = <span class="fstat-no" title="function not covered" >function (token) {</span></span>
<span class="cstat-no" title="statement not covered" >        token = di_1.resolveForwardRef(token);</span>
<span class="cstat-no" title="statement not covered" >        var compileToken;</span>
<span class="cstat-no" title="statement not covered" >        if (lang_1.isString(token)) {</span>
<span class="cstat-no" title="statement not covered" >            compileToken = new cpl.CompileTokenMetadata({ value: token });</span>
        }
        else {
<span class="cstat-no" title="statement not covered" >            compileToken = new cpl.CompileTokenMetadata({</span>
                identifier: new cpl.CompileIdentifierMetadata({ runtime: token, name: this.sanitizeTokenName(token) })
            });
        }
<span class="cstat-no" title="statement not covered" >        return compileToken;</span>
    };
<span class="cstat-no" title="statement not covered" >    RuntimeMetadataResolver.prototype.getProvidersMetadata = <span class="fstat-no" title="function not covered" >function (providers) {</span></span>
<span class="cstat-no" title="statement not covered" >        var _this = this;</span>
<span class="cstat-no" title="statement not covered" >        return providers.map(<span class="fstat-no" title="function not covered" >function (provider) {</span></span>
<span class="cstat-no" title="statement not covered" >            provider = di_1.resolveForwardRef(provider);</span>
<span class="cstat-no" title="statement not covered" >            if (lang_1.isArray(provider)) {</span>
<span class="cstat-no" title="statement not covered" >                return _this.getProvidersMetadata(provider);</span>
            }
            else <span class="cstat-no" title="statement not covered" >if (provider instanceof provider_1.Provider) {</span>
<span class="cstat-no" title="statement not covered" >                return _this.getProviderMetadata(provider);</span>
            }
            else {
<span class="cstat-no" title="statement not covered" >                return _this.getTypeMetadata(provider, null);</span>
            }
        });
    };
<span class="cstat-no" title="statement not covered" >    RuntimeMetadataResolver.prototype.getProviderMetadata = <span class="fstat-no" title="function not covered" >function (provider) {</span></span>
<span class="cstat-no" title="statement not covered" >        var compileDeps;</span>
<span class="cstat-no" title="statement not covered" >        if (lang_1.isPresent(provider.useClass)) {</span>
<span class="cstat-no" title="statement not covered" >            compileDeps = this.getDependenciesMetadata(provider.useClass, provider.dependencies);</span>
        }
        else <span class="cstat-no" title="statement not covered" >if (lang_1.isPresent(provider.useFactory)) {</span>
<span class="cstat-no" title="statement not covered" >            compileDeps = this.getDependenciesMetadata(provider.useFactory, provider.dependencies);</span>
        }
<span class="cstat-no" title="statement not covered" >        return new cpl.CompileProviderMetadata({</span>
...
<span class="cstat-no" title="statement not covered" >    RuntimeMetadataResolver.prototype.getQueriesMetadata = <span class="fstat-no" title="function not covered" >function (queries, isViewQuery) {</span></span>
<span class="cstat-no" title="statement not covered" >        var _this = this;</span>
<span class="cstat-no" title="statement not covered" >        var compileQueries = [];</span>
<span class="cstat-no" title="statement not covered" >        collection_1.StringMapWrapper.forEach(queries, <span class="fstat-no" title="function not covered" >function (query, propertyName) {</span></span>
<span class="cstat-no" title="statement not covered" >            if (query.isViewQuery === isViewQuery) {</span>
<span class="cstat-no" title="statement not covered" >                compileQueries.push(_this.getQueryMetadata(query, propertyName));</span>
            }
        });
<span class="cstat-no" title="statement not covered" >        return compileQueries;</span>
    };
<span class="cstat-no" title="statement not covered" >    RuntimeMetadataResolver.prototype.getQueryMetadata = <span class="fstat-no" title="function not covered" >function (q, propertyName) {</span></span>
<span class="cstat-no" title="statement not covered" >        var _this = this;</span>
<span class="cstat-no" title="statement not covered" >        var selectors;</span>
<span class="cstat-no" title="statement not covered" >        if (q.isVarBindingQuery) {</span>
<span class="cstat-no" title="statement not covered" >            selectors = q.varBindings.map(<span class="fstat-no" title="function not covered" >function (varName) {</span> <span class="cstat-no" title="statement not covered" >return _this.getTokenMetadata(varName); </span>});</span>
        }
        else {
<span class="cstat-no" title="statement not covered" >            selectors = [this.getTokenMetadata(q.selector)];</span>
        }
<span class="cstat-no" title="statement not covered" >        return new cpl.CompileQueryMetadata({</span>
            selectors: selectors,
            first: q.first,
...
<span class="cstat-no" title="statement not covered" >    RuntimeMetadataResolver = __decorate([</span>
        di_2.Injectable(),
...
<span class="cstat-no" title="statement not covered" >    return RuntimeMetadataResolver;</span>
}());
<span class="cstat-no" title="statement not covered" >exports.RuntimeMetadataResolver = RuntimeMetadataResolver;</span>
<span class="fstat-no" title="function not covered" >function flattenDirectives(view, platformDirectives) {</span>
<span class="cstat-no" title="statement not covered" >    var directives = [];</span>
<span class="cstat-no" title="statement not covered" >    if (lang_1.isPresent(platformDirectives)) {</span>
<span class="cstat-no" title="statement not covered" >        flattenArray(platformDirectives, directives);</span>
    }
<span class="cstat-no" title="statement not covered" >    if (lang_1.isPresent(view.directives)) {</span>
...
<span class="fstat-no" title="function not covered" >function flattenPipes(view, platformPipes) {</span>
<span class="cstat-no" title="statement not covered" >    var pipes = [];</span>
<span class="cstat-no" title="statement not covered" >    if (lang_1.isPresent(platformPipes)) {</span>
<span class="cstat-no" title="statement not covered" >        flattenArray(platformPipes, pipes);</span>
    }
<span class="cstat-no" title="statement not covered" >    if (lang_1.isPresent(view.pipes)) {</span>
<span class="cstat-no" title="statement not covered" >        flattenArray(view.pipes, pipes);</span>
    }
<span class="cstat-no" title="statement not covered" >    return pipes;</span>
}
...
<span class="fstat-no" title="function not covered" >function isValidType(value) {</span>
<span class="cstat-no" title="statement not covered" >    return lang_1.isPresent(value) &amp;&amp; (value instanceof lang_1.Type);</span>
}
<span class="fstat-no" title="function not covered" >function calcModuleUrl(reflector, type, cmpMetadata) {</span>
<span class="cstat-no" title="statement not covered" >    var moduleId = cmpMetadata.moduleId;</span>
<span class="cstat-no" title="statement not covered" >    if (lang_1.isPresent(moduleId)) {</span>
<span class="cstat-no" title="statement not covered" >        var scheme = url_resolver_1.getUrlScheme(moduleId);</span>
<span class="cstat-no" title="statement not covered" >        return lang_1.isPresent(scheme) &amp;&amp; scheme.length &gt; 0 ? moduleId :</span>
            "package:" + moduleId + util_1.MODULE_SUFFIX;
    }
    else {
<span class="cstat-no" title="statement not covered" >        return reflector.importUri(type);</span>
    }
}
