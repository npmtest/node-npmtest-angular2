...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-angular2/node_modules/angular2/src/compiler/compiler.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-angular2/node_modules/angular2/src/compiler/compiler.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-angular2/node_modules/angular2/src/compiler/</a> &#187; compiler.js</div>
</div>
<div class="body">
...
71
72
73</td><td class="line-coverage"><span class="cline-any cline-yes">4</span>
...
<span class="cstat-no" title="statement not covered" >exports.PLATFORM_DIRECTIVES = platform_directives_and_pipes_1.PLATFORM_DIRECTIVES;</span>
<span class="cstat-no" title="statement not covered" >exports.PLATFORM_PIPES = platform_directives_and_pipes_1.PLATFORM_PIPES;</span>
<span class="cstat-no" title="statement not covered" >__export(require('angular2/src/compiler/template_ast'));</span>
<span class="cstat-no" title="statement not covered" >var template_parser_1 = require('angular2/src/compiler/template_parser');</span>
<span class="cstat-no" title="statement not covered" >exports.TEMPLATE_TRANSFORMS = template_parser_1.TEMPLATE_TRANSFORMS;</span>
<span class="cstat-no" title="statement not covered" >var config_1 = require('./config');</span>
<span class="cstat-no" title="statement not covered" >exports.CompilerConfig = config_1.CompilerConfig;</span>
<span class="cstat-no" title="statement not covered" >exports.RenderTypes = config_1.RenderTypes;</span>
<span class="cstat-no" title="statement not covered" >__export(require('./compile_metadata'));</span>
<span class="cstat-no" title="statement not covered" >__export(require('./offline_compiler'));</span>
<span class="cstat-no" title="statement not covered" >var runtime_compiler_1 = require('./runtime_compiler');</span>
<span class="cstat-no" title="statement not covered" >exports.RuntimeCompiler = runtime_compiler_1.RuntimeCompiler;</span>
<span class="cstat-no" title="statement not covered" >__export(require('angular2/src/compiler/url_resolver'));</span>
<span class="cstat-no" title="statement not covered" >__export(require('angular2/src/compiler/xhr'));</span>
<span class="cstat-no" title="statement not covered" >var view_resolver_1 = require('./view_resolver');</span>
<span class="cstat-no" title="statement not covered" >exports.ViewResolver = view_resolver_1.ViewResolver;</span>
<span class="cstat-no" title="statement not covered" >var directive_resolver_1 = require('./directive_resolver');</span>
<span class="cstat-no" title="statement not covered" >exports.DirectiveResolver = directive_resolver_1.DirectiveResolver;</span>
<span class="cstat-no" title="statement not covered" >var pipe_resolver_1 = require('./pipe_resolver');</span>
<span class="cstat-no" title="statement not covered" >exports.PipeResolver = pipe_resolver_1.PipeResolver;</span>
...
<span class="cstat-no" title="statement not covered" >var template_parser_2 = require('angular2/src/compiler/template_parser');</span>
<span class="cstat-no" title="statement not covered" >var html_parser_1 = require('angular2/src/compiler/html_parser');</span>
<span class="cstat-no" title="statement not covered" >var directive_normalizer_1 = require('angular2/src/compiler/directive_normalizer');</span>
<span class="cstat-no" title="statement not covered" >var runtime_metadata_1 = require('angular2/src/compiler/runtime_metadata');</span>
<span class="cstat-no" title="statement not covered" >var style_compiler_1 = require('angular2/src/compiler/style_compiler');</span>
<span class="cstat-no" title="statement not covered" >var view_compiler_1 = require('angular2/src/compiler/view_compiler/view_compiler');</span>
<span class="cstat-no" title="statement not covered" >var config_2 = require('./config');</span>
...
<span class="cstat-no" title="statement not covered" >var runtime_compiler_2 = require('angular2/src/compiler/runtime_compiler');</span>
...
<span class="cstat-no" title="statement not covered" >var dom_element_schema_registry_1 = require('angular2/src/compiler/schema/dom_element_schema_registry');</span>
<span class="cstat-no" title="statement not covered" >var url_resolver_2 = require('angular2/src/compiler/url_resolver');</span>
<span class="cstat-no" title="statement not covered" >var parser_1 = require('./expression_parser/parser');</span>
<span class="cstat-no" title="statement not covered" >var lexer_1 = require('./expression_parser/lexer');</span>
<span class="cstat-no" title="statement not covered" >var view_resolver_2 = require('./view_resolver');</span>
<span class="cstat-no" title="statement not covered" >var directive_resolver_2 = require('./directive_resolver');</span>
<span class="cstat-no" title="statement not covered" >var pipe_resolver_2 = require('./pipe_resolver');</span>
<span class="fstat-no" title="function not covered" >function _createCompilerConfig() {</span>
<span class="cstat-no" title="statement not covered" >    return new config_2.CompilerConfig(lang_1.assertionsEnabled(), false, true);</span>
}
/**
 * A set of providers that provide `RuntimeCompiler` and its dependencies to use for
 * template compilation.
 */
<span class="cstat-no" title="statement not covered" >exports.COMPILER_PROVIDERS = lang_1.CONST_EXPR([</span>
    lexer_1.Lexer,
    parser_1.Parser,
