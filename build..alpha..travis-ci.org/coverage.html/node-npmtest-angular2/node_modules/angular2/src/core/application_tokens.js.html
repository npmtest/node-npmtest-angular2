...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-angular2/node_modules/angular2/src/core/application_tokens.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-angular2/node_modules/angular2/src/core/application_tokens.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-angular2/node_modules/angular2/src/core/</a> &#187; application_tokens.js</div>
</div>
<div class="body">
 ...
 * using this token.
 */
<span class="cstat-no" title="statement not covered" >exports.APP_ID = lang_1.CONST_EXPR(new di_1.OpaqueToken('AppId'));</span>
 ...
 */
<span class="cstat-no" title="statement not covered" >exports.APP_ID_RANDOM_PROVIDER = lang_1.CONST_EXPR(new di_1.Provider(exports.APP_ID, { useFactory: _appIdRandomProviderFactory, deps: [] }));</span>
<span class="fstat-no" title="function not covered" >function _randomChar() {</span>
<span class="cstat-no" title="statement not covered" >    return lang_1.StringWrapper.fromCharCode(97 + lang_1.Math.floor(lang_1.Math.random() * 25));</span>
}
/**
 * A function that will be executed when a platform is initialized.
 */
<span class="cstat-no" title="statement not covered" >exports.PLATFORM_INITIALIZER = lang_1.CONST_EXPR(new di_1.OpaqueToken("Platform Initializer"));</span>
/**
 * A function that will be executed when an application is initialized.
 */
<span class="cstat-no" title="statement not covered" >exports.APP_INITIALIZER = lang_1.CONST_EXPR(new di_1.OpaqueToken("Application Initializer"));</span>
/**
 * A token which indicates the root directory of the application
 */
<span class="cstat-no" title="statement not covered" >exports.PACKAGE_ROOT_URL = lang_1.CONST_EXPR(new di_1.OpaqueToken("Application Packages Root URL"));</span>
