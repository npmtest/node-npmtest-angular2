...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-angular2/node_modules/angular2/src/core/profile/profile.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-angular2/node_modules/angular2/src/core/profile/profile.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-angular2/node_modules/angular2/src/core/profile/</a> &#187; profile.js</div>
</div>
<div class="body">
...
<span class="fstat-no" title="function not covered" >function noopScope(arg0, arg1) {</span>
 ...
 *
 */
exports.wtfCreateScope = exports.wtfEnabled ? <span class="branch-0 cbranch-no" title="branch not covered" >impl.createScope </span>: <span class="fstat-no" title="function not covered" >function (signature, flags) {</span> <span class="cstat-no" title="statement not covered" >return noopScope; </span>};
/**
 ...
 */
exports.wtfLeave = exports.wtfEnabled ? <span class="branch-0 cbranch-no" title="branch not covered" >impl.leave </span>: <span class="fstat-no" title="function not covered" >function (s, r) {</span> <span class="cstat-no" title="statement not covered" >return r; </span>};
/**
 ...
 *     }
 */
exports.wtfStartTimeRange = exports.wtfEnabled ? <span class="branch-0 cbranch-no" title="branch not covered" >impl.startTimeRange </span>: <span class="fstat-no" title="function not covered" >function (rangeType, action) {</span> <span class="cstat-no" title="statement not covered" >return null; </span>};
/**
 * Ends a async time range operation.
 * [range] is the return value from [wtfStartTimeRange] Async ranges only work if WTF has been
 * enabled.
 */
exports.wtfEndTimeRange = exports.wtfEnabled ? <span class="branch-0 cbranch-no" title="branch not covered" >impl.endTimeRange </span>: <span class="fstat-no" title="function not covered" >function (r) {</span>
<span class="cstat-no" title="statement not covered" >    return null;</span>
};
